 ...
 * ```
 */
export class ZPAApplicationSegmentBrowserAccess extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZPAApplicationSegmentBrowserAccessState, opts?: pulumi.CustomResourceOptions): ZPAApplicationSegmentBrowserAccess {
        return new ZPAApplicationSegmentBrowserAccess(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/zPAApplicationSegmentBrowserAccess:ZPAApplicationSegmentBrowserAccess';

    /**
     * Returns true if the given object is an instance of ZPAApplicationSegmentBrowserAccess.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZPAApplicationSegmentBrowserAccess {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZPAApplicationSegmentBrowserAccess.__pulumiType;
    }
    ...
    public readonly clientlessApps!: pulumi.Output<outputs.ZPAApplicationSegmentBrowserAccessClientlessApp[]>;
    /**
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ZPAApplicationSegmentBrowserAccessServerGroup[]>;
    /**
     ...
     */
    constructor(name: string, args: ZPAApplicationSegmentBrowserAccessArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZPAApplicationSegmentBrowserAccessArgs | ZPAApplicationSegmentBrowserAccessState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZPAApplicationSegmentBrowserAccessState | undefined;
            ...
            const args = argsOrState as ZPAApplicationSegmentBrowserAccessArgs | undefined;
        ...
        super(ZPAApplicationSegmentBrowserAccess.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZPAApplicationSegmentBrowserAccessState {
    /**
     * (Optional) Indicates whether users can bypass ZPA to access applications. Default value is: `NEVER` and supported values are: `ALWAYS`, `NEVER` and `ON_NET`. The value `NEVER` indicates the use of the client forwarding policy.
     */
    bypassType?: pulumi.Input<string>;
    clientlessApps?: pulumi.Input<pulumi.Input<inputs.ZPAApplicationSegmentBrowserAccessClientlessApp>[]>;
    /**
     * (Optional) Default: `DEFAULT`. Supported values: `DEFAULT`, `SIEM`
     */
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ZPAApplicationSegmentBrowserAccessServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
 ...
 */
export interface ZPAApplicationSegmentBrowserAccessArgs {
    /**
     * (Optional) Indicates whether users can bypass ZPA to access applications. Default value is: `NEVER` and supported values are: `ALWAYS`, `NEVER` and `ON_NET`. The value `NEVER` indicates the use of the client forwarding policy.
     */
    bypassType?: pulumi.Input<string>;
