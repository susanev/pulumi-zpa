...
export class PolicyAccessInspectionRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:InspectionPolicy/policyAccessInspectionRule:PolicyAccessInspectionRule';
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.InspectionPolicy.PolicyAccessInspectionRuleCondition[]>;
    /**
...
export interface PolicyAccessInspectionRuleState {
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.InspectionPolicy.PolicyAccessInspectionRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
