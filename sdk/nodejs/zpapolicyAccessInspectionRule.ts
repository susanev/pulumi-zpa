...
export class ZPAPolicyAccessInspectionRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZPAPolicyAccessInspectionRuleState, opts?: pulumi.CustomResourceOptions): ZPAPolicyAccessInspectionRule {
        return new ZPAPolicyAccessInspectionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/zPAPolicyAccessInspectionRule:ZPAPolicyAccessInspectionRule';

    /**
     * Returns true if the given object is an instance of ZPAPolicyAccessInspectionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZPAPolicyAccessInspectionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZPAPolicyAccessInspectionRule.__pulumiType;
    }
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.ZPAPolicyAccessInspectionRuleCondition[]>;
    /**
     ...
     */
    constructor(name: string, args?: ZPAPolicyAccessInspectionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZPAPolicyAccessInspectionRuleArgs | ZPAPolicyAccessInspectionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZPAPolicyAccessInspectionRuleState | undefined;
            ...
            const args = argsOrState as ZPAPolicyAccessInspectionRuleArgs | undefined;
        ...
        super(ZPAPolicyAccessInspectionRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZPAPolicyAccessInspectionRuleState {
    /**
     * This is for providing the rule action.
     */
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.ZPAPolicyAccessInspectionRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
 ...
 */
export interface ZPAPolicyAccessInspectionRuleArgs {
    /**
     * This is for providing the rule action.
     */
    action?: pulumi.Input<string>;
