 ...
 * ```
 */
export function getZPALSSClientTypes(opts?: pulumi.InvokeOptions): Promise<GetZPALSSClientTypesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zpa:index/getZPALSSClientTypes:getZPALSSClientTypes", {
    }, opts);
}
 ...
 */
export interface GetZPALSSClientTypesResult {
    /**
