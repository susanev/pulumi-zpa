...
export class ZPABrowserAccess extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZPABrowserAccessState, opts?: pulumi.CustomResourceOptions): ZPABrowserAccess {
        return new ZPABrowserAccess(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/zPABrowserAccess:ZPABrowserAccess';

    /**
     * Returns true if the given object is an instance of ZPABrowserAccess.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZPABrowserAccess {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZPABrowserAccess.__pulumiType;
    }
    ...
    public readonly clientlessApps!: pulumi.Output<outputs.ZPABrowserAccessClientlessApp[]>;
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ZPABrowserAccessServerGroup[]>;
    /**
     ...
     */
    constructor(name: string, args: ZPABrowserAccessArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZPABrowserAccessArgs | ZPABrowserAccessState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZPABrowserAccessState | undefined;
            ...
            const args = argsOrState as ZPABrowserAccessArgs | undefined;
        ...
        super(ZPABrowserAccess.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZPABrowserAccessState {
    /**
     * Indicates whether users can bypass ZPA to access applications. Default: NEVER. Supported values: ALWAYS, NEVER, ON_NET.
     * The value NEVER indicates the use of the client forwarding policy.
     */
    bypassType?: pulumi.Input<string>;
    clientlessApps?: pulumi.Input<pulumi.Input<inputs.ZPABrowserAccessClientlessApp>[]>;
     ...
     * List of the server group IDs.
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ZPABrowserAccessServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
 ...
 */
export interface ZPABrowserAccessArgs {
    /**
     * Indicates whether users can bypass ZPA to access applications. Default: NEVER. Supported values: ALWAYS, NEVER, ON_NET.
     * The value NEVER indicates the use of the client forwarding policy.
     */
