 ...
 *
 * const emailUserSso = zpa.SamlAttribute.getSAMLAttribute({
 *     name: "Email_User SSO",
 * });
 * ```
 *
 ...
 * import * as zpa from "@pulumi/zpa";
 *
 * const department = zpa.SamlAttribute.getSAMLAttribute({
...
export function getSAMLAttribute(args?: GetSAMLAttributeArgs, opts?: pulumi.InvokeOptions): Promise<GetSAMLAttributeResult> {
    ...
    return pulumi.runtime.invoke("zpa:SamlAttribute/getSAMLAttribute:getSAMLAttribute", {
        "id": args.id,
