 ...
 * ```
 */
export class ZPAApplicationSegmentPRA extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZPAApplicationSegmentPRAState, opts?: pulumi.CustomResourceOptions): ZPAApplicationSegmentPRA {
        return new ZPAApplicationSegmentPRA(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/zPAApplicationSegmentPRA:ZPAApplicationSegmentPRA';

    /**
     * Returns true if the given object is an instance of ZPAApplicationSegmentPRA.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZPAApplicationSegmentPRA {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZPAApplicationSegmentPRA.__pulumiType;
    }
     ...
     */
    public readonly commonAppsDto!: pulumi.Output<outputs.ZPAApplicationSegmentPRACommonAppsDto>;
    /**
     * (Optional)
     */
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ZPAApplicationSegmentPRAServerGroup[]>;
    /**
     ...
     */
    constructor(name: string, args: ZPAApplicationSegmentPRAArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZPAApplicationSegmentPRAArgs | ZPAApplicationSegmentPRAState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZPAApplicationSegmentPRAState | undefined;
            ...
            const args = argsOrState as ZPAApplicationSegmentPRAArgs | undefined;
        ...
        super(ZPAApplicationSegmentPRA.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZPAApplicationSegmentPRAState {
    /**
     * (Optional) Indicates whether users can bypass ZPA to access applications.
     */
     ...
     * * `apps_config:` - (Required) List of applications to be configured
     */
    commonAppsDto?: pulumi.Input<inputs.ZPAApplicationSegmentPRACommonAppsDto>;
    /**
     * (Optional)
     */
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ZPAApplicationSegmentPRAServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
 ...
 */
export interface ZPAApplicationSegmentPRAArgs {
    /**
     * (Optional) Indicates whether users can bypass ZPA to access applications.
     */
    bypassType?: pulumi.Input<string>;
