 ...
 *
 * const example = zpa.Segment.getApplicationSegmentBrowserAccess({
 *     name: "example",
 * });
 * ```
 *
...
export function getApplicationSegmentBrowserAccess(args?: GetApplicationSegmentBrowserAccessArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSegmentBrowserAccessResult> {
    ...
    return pulumi.runtime.invoke("zpa:Segment/getApplicationSegmentBrowserAccess:getApplicationSegmentBrowserAccess", {
        "id": args.id,
        "name": args.name,
...
export interface GetApplicationSegmentBrowserAccessArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: inputs.Segment.GetApplicationSegmentBrowserAccessTcpPortRange[];
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: inputs.Segment.GetApplicationSegmentBrowserAccessUdpPortRange[];
}
...
export interface GetApplicationSegmentBrowserAccessResult {
    ...
    readonly clientlessApps: outputs.Segment.GetApplicationSegmentBrowserAccessClientlessApp[];
    /**
     * (string)
     */
    ...
    readonly serverGroups: outputs.Segment.GetApplicationSegmentBrowserAccessServerGroup[];
    /**
     * (string) TCP port ranges used to access the app.
     */
...
export interface GetApplicationSegmentBrowserAccessOutputArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: pulumi.Input<pulumi.Input<inputs.Segment.GetApplicationSegmentBrowserAccessTcpPortRangeArgs>[]>;
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: pulumi.Input<pulumi.Input<inputs.Segment.GetApplicationSegmentBrowserAccessUdpPortRangeArgs>[]>;
}
