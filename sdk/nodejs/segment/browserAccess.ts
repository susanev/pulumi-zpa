...
export class BrowserAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:Segment/browserAccess:BrowserAccess';
    ...
    public readonly clientlessApps!: pulumi.Output<outputs.Segment.BrowserAccessClientlessApp[]>;
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.Segment.BrowserAccessServerGroup[]>;
    /**
...
export interface BrowserAccessState {
    ...
    clientlessApps?: pulumi.Input<pulumi.Input<inputs.Segment.BrowserAccessClientlessApp>[]>;
     ...
     * List of the server group IDs.
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.Segment.BrowserAccessServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
