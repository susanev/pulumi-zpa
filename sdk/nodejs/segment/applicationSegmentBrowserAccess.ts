 ...
 *     enabled: true,
 * });
 * const exampleAppConnectorGroup = zpa.Connector.getAppConnectorGroup({
 *     name: "AWS-Connector",
 * });
 ...
 * const browserAccessApps = new zpa.segment.ApplicationSegmentBrowserAccess("browserAccessApps", {
...
export class ApplicationSegmentBrowserAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:Segment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess';
    ...
    public readonly clientlessApps!: pulumi.Output<outputs.Segment.ApplicationSegmentBrowserAccessClientlessApp[]>;
    /**
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.Segment.ApplicationSegmentBrowserAccessServerGroup[]>;
    /**
...
export interface ApplicationSegmentBrowserAccessState {
    ...
    clientlessApps?: pulumi.Input<pulumi.Input<inputs.Segment.ApplicationSegmentBrowserAccessClientlessApp>[]>;
    /**
     * (Optional) Default: `DEFAULT`. Supported values: `DEFAULT`, `SIEM`
     */
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.Segment.ApplicationSegmentBrowserAccessServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
