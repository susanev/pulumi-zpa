 ...
 *
 * const _this = new zpa.segment.ApplicationSegmentPRA("this", {
...
export class ApplicationSegmentPRA extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA';
     ...
     */
    public readonly commonAppsDto!: pulumi.Output<outputs.Segment.ApplicationSegmentPRACommonAppsDto>;
    /**
     * (Optional)
     */
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.Segment.ApplicationSegmentPRAServerGroup[]>;
    /**
...
export interface ApplicationSegmentPRAState {
     ...
     * * `apps_config:` - (Required) List of applications to be configured
     */
    commonAppsDto?: pulumi.Input<inputs.Segment.ApplicationSegmentPRACommonAppsDto>;
    /**
     * (Optional)
     */
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.Segment.ApplicationSegmentPRAServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
