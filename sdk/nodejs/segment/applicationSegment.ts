...
export class ApplicationSegment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:Segment/applicationSegment:ApplicationSegment';
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.Segment.ApplicationSegmentServerGroup[]>;
    /**
...
export interface ApplicationSegmentState {
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.Segment.ApplicationSegmentServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
