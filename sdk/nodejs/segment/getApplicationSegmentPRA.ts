 ...
 *
 * const this = zpa.Segment.getApplicationSegmentPRA({
 *     name: "PRA_Example",
 * });
 * ```
 *
...
export function getApplicationSegmentPRA(args?: GetApplicationSegmentPRAArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSegmentPRAResult> {
    ...
    return pulumi.runtime.invoke("zpa:Segment/getApplicationSegmentPRA:getApplicationSegmentPRA", {
        "id": args.id,
        "name": args.name,
...
export interface GetApplicationSegmentPRAArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: inputs.Segment.GetApplicationSegmentPRATcpPortRange[];
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: inputs.Segment.GetApplicationSegmentPRAUdpPortRange[];
}
...
export interface GetApplicationSegmentPRAResult {
     ...
     */
    readonly serverGroups: outputs.Segment.GetApplicationSegmentPRAServerGroup[];
    /**
     * (string) TCP port ranges used to access the app.
     * * `app_id:` - (string)
     ...
     */
    readonly sraApps: outputs.Segment.GetApplicationSegmentPRASraApp[];
    /**
     * (string) TCP port ranges used to access the app.
     */
...
export interface GetApplicationSegmentPRAOutputArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: pulumi.Input<pulumi.Input<inputs.Segment.GetApplicationSegmentPRATcpPortRangeArgs>[]>;
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: pulumi.Input<pulumi.Input<inputs.Segment.GetApplicationSegmentPRAUdpPortRangeArgs>[]>;
}
