 ...
 *
 * const this = zpa.Segment.getApplicationSegmentInspection({
...
export function getApplicationSegmentInspection(args?: GetApplicationSegmentInspectionArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSegmentInspectionResult> {
    ...
    return pulumi.runtime.invoke("zpa:Segment/getApplicationSegmentInspection:getApplicationSegmentInspection", {
        "id": args.id,
        "name": args.name,
...
export interface GetApplicationSegmentInspectionArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: inputs.Segment.GetApplicationSegmentInspectionTcpPortRange[];
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: inputs.Segment.GetApplicationSegmentInspectionUdpPortRange[];
}
...
export interface GetApplicationSegmentInspectionResult {
     ...
     */
    readonly inspectionApps: outputs.Segment.GetApplicationSegmentInspectionInspectionApp[];
    /**
     * (bool)
     */
     ...
     */
    readonly serverGroups: outputs.Segment.GetApplicationSegmentInspectionServerGroup[];
    /**
     * (string) TCP port ranges used to access the app.
     */
...
export interface GetApplicationSegmentInspectionOutputArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: pulumi.Input<pulumi.Input<inputs.Segment.GetApplicationSegmentInspectionTcpPortRangeArgs>[]>;
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: pulumi.Input<pulumi.Input<inputs.Segment.GetApplicationSegmentInspectionUdpPortRangeArgs>[]>;
}
