...
export class PolicyAccessTimeOutRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:TimeoutPolicy/policyAccessTimeOutRule:PolicyAccessTimeOutRule';
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.TimeoutPolicy.PolicyAccessTimeOutRuleCondition[]>;
    /**
...
export interface PolicyAccessTimeOutRuleState {
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.TimeoutPolicy.PolicyAccessTimeOutRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
