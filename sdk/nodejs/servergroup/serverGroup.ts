...
export class ServerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ServerGroup/serverGroup:ServerGroup';
     ...
     */
    public readonly appConnectorGroups!: pulumi.Output<outputs.ServerGroup.ServerGroupAppConnectorGroup[]>;
    /**
     * This field is a json array of app-connector-id only.
     */
    public readonly applications!: pulumi.Output<outputs.ServerGroup.ServerGroupApplication[]>;
     ...
     */
    public readonly servers!: pulumi.Output<outputs.ServerGroup.ServerGroupServer[]>;
...
export interface ServerGroupState {
     ...
     * List of app-connector IDs.
     */
    appConnectorGroups?: pulumi.Input<pulumi.Input<inputs.ServerGroup.ServerGroupAppConnectorGroup>[]>;
    /**
     * This field is a json array of app-connector-id only.
     */
    applications?: pulumi.Input<pulumi.Input<inputs.ServerGroup.ServerGroupApplication>[]>;
     ...
     * (Block List) This field is a list of servers that are applicable only when dynamic discovery is disabled. Server name is required only in cases where the new servers need to be created in this API.
     */
    servers?: pulumi.Input<pulumi.Input<inputs.ServerGroup.ServerGroupServer>[]>;
}
