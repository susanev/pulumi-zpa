 ...
 *
 * const example = zpa.trustedNetwork.getTrustedNetwork({
 ...
 * import * as zpa from "@pulumi/zpa";
 *
 * const example1 = zpa.trustedNetwork.getTrustedNetwork({
...
export function getTrustedNetwork(args?: GetTrustedNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetTrustedNetworkResult> {
    ...
    return pulumi.runtime.invoke("zpa:trustedNetwork/getTrustedNetwork:getTrustedNetwork", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
