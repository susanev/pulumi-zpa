 ...
 *
 * const foo = zpa.Connector.getAppConnectorGroup({
 *     name: "DataCenter",
 * });
 * ```
 *
...
export function getAppConnectorGroup(args?: GetAppConnectorGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetAppConnectorGroupResult> {
    ...
    return pulumi.runtime.invoke("zpa:Connector/getAppConnectorGroup:getAppConnectorGroup", {
        "id": args.id,
        "name": args.name,
...
export interface GetAppConnectorGroupResult {
    ...
    readonly connectors: outputs.Connector.GetAppConnectorGroupConnector[];
    /**
     * (String)
     */
    ...
    readonly serverGroups: outputs.Connector.GetAppConnectorGroupServerGroup[];
