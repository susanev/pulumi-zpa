...
export class ApplicationSegmentInspection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ApplicationSegment/applicationSegmentInspection:ApplicationSegmentInspection';
     ...
     */
    public readonly commonAppsDto!: pulumi.Output<outputs.ApplicationSegment.ApplicationSegmentInspectionCommonAppsDto>;
    /**
     * (Optional)
     */
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ApplicationSegment.ApplicationSegmentInspectionServerGroup[]>;
    /**
...
export interface ApplicationSegmentInspectionState {
     ...
     * * `apps_config:` - (Required) List of applications to be configured
     */
    commonAppsDto?: pulumi.Input<inputs.ApplicationSegment.ApplicationSegmentInspectionCommonAppsDto>;
    /**
     * (Optional)
     */
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.ApplicationSegmentInspectionServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
