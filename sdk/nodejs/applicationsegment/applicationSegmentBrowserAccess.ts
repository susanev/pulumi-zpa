...
export class ApplicationSegmentBrowserAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ApplicationSegment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess';
    ...
    public readonly clientlessApps!: pulumi.Output<outputs.ApplicationSegment.ApplicationSegmentBrowserAccessClientlessApp[]>;
    /**
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ApplicationSegment.ApplicationSegmentBrowserAccessServerGroup[]>;
    /**
...
export interface ApplicationSegmentBrowserAccessState {
    ...
    clientlessApps?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.ApplicationSegmentBrowserAccessClientlessApp>[]>;
    /**
     * (Optional) Default: `DEFAULT`. Supported values: `DEFAULT`, `SIEM`
     */
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.ApplicationSegmentBrowserAccessServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
