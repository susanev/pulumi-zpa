...
export class BrowserAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ApplicationSegment/browserAccess:BrowserAccess';
    ...
    public readonly clientlessApps!: pulumi.Output<outputs.ApplicationSegment.BrowserAccessClientlessApp[]>;
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ApplicationSegment.BrowserAccessServerGroup[]>;
    /**
...
export interface BrowserAccessState {
    ...
    clientlessApps?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.BrowserAccessClientlessApp>[]>;
     ...
     * List of the server group IDs.
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.BrowserAccessServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
