...
export class ApplicationSegment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ApplicationSegment/applicationSegment:ApplicationSegment';
     ...
     */
    public readonly serverGroups!: pulumi.Output<outputs.ApplicationSegment.ApplicationSegmentServerGroup[]>;
    /**
...
export interface ApplicationSegmentState {
     ...
     * List of Server Group IDs
     */
    serverGroups?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.ApplicationSegmentServerGroup>[]>;
    /**
     * TCP port ranges used to access the app.
     */
