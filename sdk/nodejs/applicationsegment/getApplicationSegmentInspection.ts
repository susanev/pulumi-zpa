...
export function getApplicationSegmentInspection(args?: GetApplicationSegmentInspectionArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSegmentInspectionResult> {
    ...
    return pulumi.runtime.invoke("zpa:ApplicationSegment/getApplicationSegmentInspection:getApplicationSegmentInspection", {
        "id": args.id,
        "name": args.name,
...
export interface GetApplicationSegmentInspectionArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: inputs.ApplicationSegment.GetApplicationSegmentInspectionTcpPortRange[];
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: inputs.ApplicationSegment.GetApplicationSegmentInspectionUdpPortRange[];
}
...
export interface GetApplicationSegmentInspectionResult {
     ...
     */
    readonly inspectionApps: outputs.ApplicationSegment.GetApplicationSegmentInspectionInspectionApp[];
    /**
     * (bool)
     */
     ...
     */
    readonly serverGroups: outputs.ApplicationSegment.GetApplicationSegmentInspectionServerGroup[];
    /**
     * (string) TCP port ranges used to access the app.
     */
...
export interface GetApplicationSegmentInspectionOutputArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.GetApplicationSegmentInspectionTcpPortRangeArgs>[]>;
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.GetApplicationSegmentInspectionUdpPortRangeArgs>[]>;
}
