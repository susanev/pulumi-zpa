...
export function getApplicationSegmentBrowserAccess(args?: GetApplicationSegmentBrowserAccessArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSegmentBrowserAccessResult> {
    ...
    return pulumi.runtime.invoke("zpa:ApplicationSegment/getApplicationSegmentBrowserAccess:getApplicationSegmentBrowserAccess", {
        "id": args.id,
        "name": args.name,
...
export interface GetApplicationSegmentBrowserAccessArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: inputs.ApplicationSegment.GetApplicationSegmentBrowserAccessTcpPortRange[];
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: inputs.ApplicationSegment.GetApplicationSegmentBrowserAccessUdpPortRange[];
}
...
export interface GetApplicationSegmentBrowserAccessResult {
    ...
    readonly clientlessApps: outputs.ApplicationSegment.GetApplicationSegmentBrowserAccessClientlessApp[];
    /**
     * (string)
     */
    ...
    readonly serverGroups: outputs.ApplicationSegment.GetApplicationSegmentBrowserAccessServerGroup[];
    /**
     * (string) TCP port ranges used to access the app.
     */
...
export interface GetApplicationSegmentBrowserAccessOutputArgs {
     ...
     * * `to:`
     */
    tcpPortRanges?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.GetApplicationSegmentBrowserAccessTcpPortRangeArgs>[]>;
    /**
     * (string) UDP port ranges used to access the app.
     * * `from:`
     * * `to:`
     */
    udpPortRanges?: pulumi.Input<pulumi.Input<inputs.ApplicationSegment.GetApplicationSegmentBrowserAccessUdpPortRangeArgs>[]>;
}
