...
export class PolicyAccessForwardingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ForwardPolicy/policyAccessForwardingRule:PolicyAccessForwardingRule';
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.ForwardPolicy.PolicyAccessForwardingRuleCondition[]>;
    /**
...
export interface PolicyAccessForwardingRuleState {
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.ForwardPolicy.PolicyAccessForwardingRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
