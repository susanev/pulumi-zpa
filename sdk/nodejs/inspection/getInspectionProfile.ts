 ...
 *
 * const this = zpa.Inspection.getInspectionProfile({
 *     name: "Example",
 * });
 * ```
 */
export function getInspectionProfile(args?: GetInspectionProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetInspectionProfileResult> {
    ...
    return pulumi.runtime.invoke("zpa:Inspection/getInspectionProfile:getInspectionProfile", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetInspectionProfileResult {
     ...
     */
    readonly controlsInfos: outputs.Inspection.GetInspectionProfileControlsInfo[];
    readonly creationTime: string;
    /**
     * (string) Types for custom controls
     */
    readonly customControls: outputs.Inspection.GetInspectionProfileCustomControl[];
    /**
     ...
     */
    readonly predefinedControls: outputs.Inspection.GetInspectionProfilePredefinedControl[];
    readonly predefinedControlsVersion: string;
    /**
     * (string)
     */
    readonly webSocketControls: outputs.Inspection.GetInspectionProfileWebSocketControl[];
}
/**
 * Use the **zpa_inspection_profile** data source to get information about an inspection profile in the Zscaler Private Access cloud. This resource can then be referenced in an inspection custom control resource.
 *
