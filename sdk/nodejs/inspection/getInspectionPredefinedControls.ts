 ...
 *
 * const example = zpa.Inspection.getInspectionPredefinedControls({
...
export function getInspectionPredefinedControls(args?: GetInspectionPredefinedControlsArgs, opts?: pulumi.InvokeOptions): Promise<GetInspectionPredefinedControlsResult> {
    ...
    return pulumi.runtime.invoke("zpa:Inspection/getInspectionPredefinedControls:getInspectionPredefinedControls", {
        "id": args.id,
        "name": args.name,
...
export interface GetInspectionPredefinedControlsResult {
     ...
     * (Computed)
     */
    readonly associatedInspectionProfileNames: outputs.Inspection.GetInspectionPredefinedControlsAssociatedInspectionProfileName[];
    /**
     * (Computed)
     */
