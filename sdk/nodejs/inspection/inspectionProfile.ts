...
export class InspectionProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:Inspection/inspectionProfile:InspectionProfile';
     ...
     */
    public readonly controlsInfos!: pulumi.Output<outputs.Inspection.InspectionProfileControlsInfo[]>;
    /**
     * (Optional) Types for custom controls
     */
    public readonly customControls!: pulumi.Output<outputs.Inspection.InspectionProfileCustomControl[]>;
    /**
    ...
    /**
     * The predefined controls. The default predefined control `Preprocessors` are mandatory and injected in the request by default. Individual `predefinedControls` can be set by using the data source `dataSourceZpaPredefinedControls` or by group using the data source `zpa.Inspection.getInspectionAllPredefinedControls`.
     */
    public readonly predefinedControls!: pulumi.Output<outputs.Inspection.InspectionProfilePredefinedControl[]>;
    public readonly predefinedControlsVersion!: pulumi.Output<string>;
    /**
     * (string)
     */
    public readonly webSocketControls!: pulumi.Output<outputs.Inspection.InspectionProfileWebSocketControl[]>;
...
export interface InspectionProfileState {
     ...
     * (Optional) Types for custom controls
     */
    controlsInfos?: pulumi.Input<pulumi.Input<inputs.Inspection.InspectionProfileControlsInfo>[]>;
    /**
     * (Optional) Types for custom controls
     */
    customControls?: pulumi.Input<pulumi.Input<inputs.Inspection.InspectionProfileCustomControl>[]>;
    /**
     * Description of the inspection profile.
     */
     ...
     * The predefined controls. The default predefined control `Preprocessors` are mandatory and injected in the request by default. Individual `predefinedControls` can be set by using the data source `dataSourceZpaPredefinedControls` or by group using the data source `zpa.Inspection.getInspectionAllPredefinedControls`.
     */
    predefinedControls?: pulumi.Input<pulumi.Input<inputs.Inspection.InspectionProfilePredefinedControl>[]>;
    predefinedControlsVersion?: pulumi.Input<string>;
    /**
     * (string)
     */
    webSocketControls?: pulumi.Input<pulumi.Input<inputs.Inspection.InspectionProfileWebSocketControl>[]>;
}
