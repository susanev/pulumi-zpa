...
export class InspectionCustomControls extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:Inspection/inspectionCustomControls:InspectionCustomControls';
     ...
     */
    public readonly associatedInspectionProfileNames!: pulumi.Output<outputs.Inspection.InspectionCustomControlsAssociatedInspectionProfileName[]>;
     ...
     */
    public readonly rules!: pulumi.Output<outputs.Inspection.InspectionCustomControlsRule[]>;
    /**
...
export interface InspectionCustomControlsState {
     ...
     * Name of the inspection profile
     */
    associatedInspectionProfileNames?: pulumi.Input<pulumi.Input<inputs.Inspection.InspectionCustomControlsAssociatedInspectionProfileName>[]>;
     ...
     * Rules of the custom controls applied as conditions (JSON)
     */
    rules?: pulumi.Input<pulumi.Input<inputs.Inspection.InspectionCustomControlsRule>[]>;
    /**
     * Severity of the control number
     */
