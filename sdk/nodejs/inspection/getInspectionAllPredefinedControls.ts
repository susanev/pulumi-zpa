 ...
 *
 * const this = zpa.Inspection.getInspectionAllPredefinedControls({
...
export function getInspectionAllPredefinedControls(args: GetInspectionAllPredefinedControlsArgs, opts?: pulumi.InvokeOptions): Promise<GetInspectionAllPredefinedControlsResult> {
    ...
    return pulumi.runtime.invoke("zpa:Inspection/getInspectionAllPredefinedControls:getInspectionAllPredefinedControls", {
...
export interface GetInspectionAllPredefinedControlsResult {
     ...
     */
    readonly id: string;
    readonly lists: outputs.Inspection.GetInspectionAllPredefinedControlsList[];
