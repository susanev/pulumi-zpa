 ...
 * const serviceEdgeGroupSjc = new zpa.serviceedge.ServiceEdgeGroup("serviceEdgeGroupSjc", {
 ...
 * const serviceEdgeGroupNyc = new zpa.serviceedge.ServiceEdgeGroup("serviceEdgeGroupNyc", {
...
export class ServiceEdgeGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:ServiceEdge/serviceEdgeGroup:ServiceEdgeGroup';
    ...
    public readonly serviceEdges!: pulumi.Output<outputs.ServiceEdge.ServiceEdgeGroupServiceEdge[] | undefined>;
    /**
     * Trusted networks for this Service Edge Group. List of trusted network objects
     */
    public readonly trustedNetworks!: pulumi.Output<outputs.ServiceEdge.ServiceEdgeGroupTrustedNetwork[] | undefined>;
    /**
...
export interface ServiceEdgeGroupState {
    ...
    serviceEdges?: pulumi.Input<pulumi.Input<inputs.ServiceEdge.ServiceEdgeGroupServiceEdge>[]>;
    /**
     * Trusted networks for this Service Edge Group. List of trusted network objects
     */
    trustedNetworks?: pulumi.Input<pulumi.Input<inputs.ServiceEdge.ServiceEdgeGroupTrustedNetwork>[]>;
    /**
     * Service Edges in this group will attempt to update to a newer version of the software during this specified day. Default value: `SUNDAY` List of valid days (i.e., Sunday, Monday)
     */
