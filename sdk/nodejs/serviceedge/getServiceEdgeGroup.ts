 ...
 *
 * const foo = zpa.ServiceEdge.getServiceEdgeGroup({
 *     name: "DataCenter",
 * });
 * ```
 *
...
export function getServiceEdgeGroup(args?: GetServiceEdgeGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEdgeGroupResult> {
    ...
    return pulumi.runtime.invoke("zpa:ServiceEdge/getServiceEdgeGroup:getServiceEdgeGroup", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetServiceEdgeGroupResult {
     ...
     * (string)
     */
    readonly serviceEdges: outputs.ServiceEdge.GetServiceEdgeGroupServiceEdge[];
    /**
     * (string)
     */
    readonly trustedNetworks: outputs.ServiceEdge.GetServiceEdgeGroupTrustedNetwork[];
    /**
