 ...
 *
 * const givenName = zpa.ScimAttribute.getSCIMAttributeHeader({
 *     idpName: "IdP_Name",
 *     name: "name.givenName",
 * });
 * const familyName = zpa.ScimAttribute.getSCIMAttributeHeader({
 *     idpName: "IdP_Name",
...
export function getSCIMAttributeHeader(args?: GetSCIMAttributeHeaderArgs, opts?: pulumi.InvokeOptions): Promise<GetSCIMAttributeHeaderResult> {
    ...
    return pulumi.runtime.invoke("zpa:ScimAttribute/getSCIMAttributeHeader:getSCIMAttributeHeader", {
        "idpId": args.idpId,
