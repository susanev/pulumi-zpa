 ...
 *
 * const givenName = zpa.idpController.getSCIMAttributeHeader({
 *     idpName: "IdP_Name",
 *     name: "name.givenName",
 * });
 * const familyName = zpa.idpController.getSCIMAttributeHeader({
 *     idpName: "IdP_Name",
...
export function getSCIMAttributeHeader(args?: GetSCIMAttributeHeaderArgs, opts?: pulumi.InvokeOptions): Promise<GetSCIMAttributeHeaderResult> {
    ...
    return pulumi.runtime.invoke("zpa:idpController/getSCIMAttributeHeader:getSCIMAttributeHeader", {
        "idpId": args.idpId,
