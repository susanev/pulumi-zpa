 ...
 * const testSegmentGroup = new zpa.segmentgroup.SegmentGroup("testSegmentGroup", {
...
export class SegmentGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zpa:SegmentGroup/segmentGroup:SegmentGroup';
    ...
    public readonly applications!: pulumi.Output<outputs.SegmentGroup.SegmentGroupApplication[]>;
    /**
     * (Optional)
     */
...
export interface SegmentGroupState {
    applications?: pulumi.Input<pulumi.Input<inputs.SegmentGroup.SegmentGroupApplication>[]>;
    /**
     * (Optional)
     */
