 ...
 */
export class ZPALSSConfigController extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZPALSSConfigControllerState, opts?: pulumi.CustomResourceOptions): ZPALSSConfigController {
        return new ZPALSSConfigController(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/zPALSSConfigController:ZPALSSConfigController';

    /**
     * Returns true if the given object is an instance of ZPALSSConfigController.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZPALSSConfigController {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZPALSSConfigController.__pulumiType;
    }

    /**
     * (Required)
     */
    public readonly config!: pulumi.Output<outputs.ZPALSSConfigControllerConfig | undefined>;
    /**
     * (Optional)
     */
    public readonly connectorGroups!: pulumi.Output<outputs.ZPALSSConfigControllerConnectorGroup[] | undefined>;
    public /*out*/ readonly policyRuleId!: pulumi.Output<string>;
    /**
     * (Optional)
     */
    public readonly policyRuleResource!: pulumi.Output<outputs.ZPALSSConfigControllerPolicyRuleResource | undefined>;
     ...
     */
    constructor(name: string, args?: ZPALSSConfigControllerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZPALSSConfigControllerArgs | ZPALSSConfigControllerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZPALSSConfigControllerState | undefined;
            ...
            const args = argsOrState as ZPALSSConfigControllerArgs | undefined;
        ...
        super(ZPALSSConfigController.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZPALSSConfigControllerState {
    /**
     * (Required)
     */
    config?: pulumi.Input<inputs.ZPALSSConfigControllerConfig>;
    /**
     * (Optional)
     */
    connectorGroups?: pulumi.Input<pulumi.Input<inputs.ZPALSSConfigControllerConnectorGroup>[]>;
    policyRuleId?: pulumi.Input<string>;
    /**
     * (Optional)
     */
    policyRuleResource?: pulumi.Input<inputs.ZPALSSConfigControllerPolicyRuleResource>;
}

/**
 * The set of arguments for constructing a ZPALSSConfigController resource.
 */
export interface ZPALSSConfigControllerArgs {
    /**
     * (Required)
     */
    config?: pulumi.Input<inputs.ZPALSSConfigControllerConfig>;
