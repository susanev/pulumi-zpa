...
export function getAppConnectorGroup(args?: GetAppConnectorGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetAppConnectorGroupResult> {
    ...
    return pulumi.runtime.invoke("zpa:AppConnectorGroup/getAppConnectorGroup:getAppConnectorGroup", {
        "id": args.id,
        "name": args.name,
...
export interface GetAppConnectorGroupResult {
    ...
    readonly connectors: outputs.AppConnectorGroup.GetAppConnectorGroupConnector[];
    /**
     * (String)
     */
    ...
    readonly serverGroups: outputs.AppConnectorGroup.GetAppConnectorGroupServerGroup[];
