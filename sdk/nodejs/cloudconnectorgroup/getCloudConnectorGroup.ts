...
export function getCloudConnectorGroup(args?: GetCloudConnectorGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudConnectorGroupResult> {
    ...
    return pulumi.runtime.invoke("zpa:CloudConnectorGroup/getCloudConnectorGroup:getCloudConnectorGroup", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetCloudConnectorGroupResult {
     ...
     */
    readonly cloudConnectors: outputs.CloudConnectorGroup.GetCloudConnectorGroupCloudConnector[];
    /**
     * (string) - Only applicable for a GET request. Ignored in PUT/POST/DELETE requests.
     */
