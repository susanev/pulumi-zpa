...
//			_, err := LSSConfig.GetLSSLogTypeFormats(ctx, &lssconfig.GetLSSLogTypeFormatsArgs{
...
func GetLSSLogTypeFormats(ctx *pulumi.Context, args *GetLSSLogTypeFormatsArgs, opts ...pulumi.InvokeOption) (*GetLSSLogTypeFormatsResult, error) {
	...
	err := ctx.Invoke("zpa:LSSConfig/getLSSLogTypeFormats:getLSSLogTypeFormats", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
