...
func NewConnectorGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:AppConnectorGroup/connectorGroup:ConnectorGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorGroup(ctx *pulumi.Context,
	...
	var resource ConnectorGroup
	err := ctx.ReadResource("zpa:AppConnectorGroup/connectorGroup:ConnectorGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
