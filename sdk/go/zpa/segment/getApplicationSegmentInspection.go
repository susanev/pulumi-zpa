...
//			_, err := Segment.GetApplicationSegmentInspection(ctx, &segment.GetApplicationSegmentInspectionArgs{
...
func LookupApplicationSegmentInspection(ctx *pulumi.Context, args *LookupApplicationSegmentInspectionArgs, opts ...pulumi.InvokeOption) (*LookupApplicationSegmentInspectionResult, error) {
	...
	err := ctx.Invoke("zpa:Segment/getApplicationSegmentInspection:getApplicationSegmentInspection", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupApplicationSegmentInspectionArgs struct {
	...
	// * `from:`
	// * `to:`
	TcpPortRanges []GetApplicationSegmentInspectionTcpPortRange `pulumi:"tcpPortRanges"`
	// (string) UDP port ranges used to access the app.
	// * `from:`
	// * `to:`
	UdpPortRanges []GetApplicationSegmentInspectionUdpPortRange `pulumi:"udpPortRanges"`
}
...
type LookupApplicationSegmentInspectionOutputArgs struct {
	...
	// * `from:`
	// * `to:`
	TcpPortRanges GetApplicationSegmentInspectionTcpPortRangeArrayInput `pulumi:"tcpPortRanges"`
	// (string) UDP port ranges used to access the app.
	// * `from:`
	// * `to:`
	UdpPortRanges GetApplicationSegmentInspectionUdpPortRangeArrayInput `pulumi:"udpPortRanges"`
}
