...
//			_, err := Segment.GetApplicationSegmentBrowserAccess(ctx, &segment.GetApplicationSegmentBrowserAccessArgs{
...
func LookupApplicationSegmentBrowserAccess(ctx *pulumi.Context, args *LookupApplicationSegmentBrowserAccessArgs, opts ...pulumi.InvokeOption) (*LookupApplicationSegmentBrowserAccessResult, error) {
	...
	err := ctx.Invoke("zpa:Segment/getApplicationSegmentBrowserAccess:getApplicationSegmentBrowserAccess", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupApplicationSegmentBrowserAccessArgs struct {
	...
	// * `from:`
	// * `to:`
	TcpPortRanges []GetApplicationSegmentBrowserAccessTcpPortRange `pulumi:"tcpPortRanges"`
	// (string) UDP port ranges used to access the app.
	// * `from:`
	// * `to:`
	UdpPortRanges []GetApplicationSegmentBrowserAccessUdpPortRange `pulumi:"udpPortRanges"`
}
...
type LookupApplicationSegmentBrowserAccessOutputArgs struct {
	...
	// * `from:`
	// * `to:`
	TcpPortRanges GetApplicationSegmentBrowserAccessTcpPortRangeArrayInput `pulumi:"tcpPortRanges"`
	// (string) UDP port ranges used to access the app.
	// * `from:`
	// * `to:`
	UdpPortRanges GetApplicationSegmentBrowserAccessUdpPortRangeArrayInput `pulumi:"udpPortRanges"`
}
