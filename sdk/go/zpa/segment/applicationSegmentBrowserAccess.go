...
//				return err
//			}
//			exampleAppConnectorGroup, err := Connector.GetAppConnectorGroup(ctx, &connector.GetAppConnectorGroupArgs{
...
//				return err
//			}
//			_, err = Segment.NewApplicationSegmentBrowserAccess(ctx, "browserAccessApps", &Segment.ApplicationSegmentBrowserAccessArgs{
...
//				ClientlessApps: segment.ApplicationSegmentBrowserAccessClientlessAppArray{
//					&segment.ApplicationSegmentBrowserAccessClientlessAppArgs{
...
//					},
//				},
//				ServerGroups: segment.ApplicationSegmentBrowserAccessServerGroupArray{
//					&segment.ApplicationSegmentBrowserAccessServerGroupArgs{
//						Ids: pulumi.StringArray{
...
func NewApplicationSegmentBrowserAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Segment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSegmentBrowserAccess(ctx *pulumi.Context,
	...
	var resource ApplicationSegmentBrowserAccess
	err := ctx.ReadResource("zpa:Segment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
