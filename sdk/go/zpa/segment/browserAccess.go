...
func NewBrowserAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Segment/browserAccess:BrowserAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBrowserAccess(ctx *pulumi.Context,
	...
	var resource BrowserAccess
	err := ctx.ReadResource("zpa:Segment/browserAccess:BrowserAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
