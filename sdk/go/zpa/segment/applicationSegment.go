...
func NewApplicationSegment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Segment/applicationSegment:ApplicationSegment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSegment(ctx *pulumi.Context,
	...
	var resource ApplicationSegment
	err := ctx.ReadResource("zpa:Segment/applicationSegment:ApplicationSegment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
