...
//			_, err := Segment.NewApplicationSegmentPRA(ctx, "this", &Segment.ApplicationSegmentPRAArgs{
...
//				ServerGroups: segment.ApplicationSegmentPRAServerGroupArray{
//					&segment.ApplicationSegmentPRAServerGroupArgs{
//						Ids: pulumi.StringArray{
//							zpa_server_group.This.Id,
//						},
//					},
//				},
//				CommonAppsDto: &segment.ApplicationSegmentPRACommonAppsDtoArgs{
//					AppsConfigs: segment.ApplicationSegmentPRACommonAppsDtoAppsConfigArray{
//						&segment.ApplicationSegmentPRACommonAppsDtoAppsConfigArgs{
...
// ```sh
//
//	$ pulumi import zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA example <application_segment_id>
//
// ```
//
//	or
...
// ```sh
//
//	$ pulumi import zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA example <application_segment_name>
//
// ```
...
func NewApplicationSegmentPRA(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSegmentPRA(ctx *pulumi.Context,
	...
	var resource ApplicationSegmentPRA
	err := ctx.ReadResource("zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
