...
//			_, err := Segment.GetApplicationSegmentPRA(ctx, &segment.GetApplicationSegmentPRAArgs{
...
func LookupApplicationSegmentPRA(ctx *pulumi.Context, args *LookupApplicationSegmentPRAArgs, opts ...pulumi.InvokeOption) (*LookupApplicationSegmentPRAResult, error) {
	...
	err := ctx.Invoke("zpa:Segment/getApplicationSegmentPRA:getApplicationSegmentPRA", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupApplicationSegmentPRAArgs struct {
	...
	// * `from:`
	// * `to:`
	TcpPortRanges []GetApplicationSegmentPRATcpPortRange `pulumi:"tcpPortRanges"`
	// (string) UDP port ranges used to access the app.
	// * `from:`
	// * `to:`
	UdpPortRanges []GetApplicationSegmentPRAUdpPortRange `pulumi:"udpPortRanges"`
}
...
type LookupApplicationSegmentPRAOutputArgs struct {
	...
	// * `from:`
	// * `to:`
	TcpPortRanges GetApplicationSegmentPRATcpPortRangeArrayInput `pulumi:"tcpPortRanges"`
	// (string) UDP port ranges used to access the app.
	// * `from:`
	// * `to:`
	UdpPortRanges GetApplicationSegmentPRAUdpPortRangeArrayInput `pulumi:"udpPortRanges"`
}
