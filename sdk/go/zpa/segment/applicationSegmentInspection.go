...
//				return err
//			}
//			_, err = Segment.NewApplicationSegmentInspection(ctx, "this", &Segment.ApplicationSegmentInspectionArgs{
...
//				ServerGroups: segment.ApplicationSegmentInspectionServerGroupArray{
//					&segment.ApplicationSegmentInspectionServerGroupArgs{
//						Ids: pulumi.StringArray{
//							zpa_server_group.This.Id,
//						},
//					},
//				},
//				CommonAppsDto: &segment.ApplicationSegmentInspectionCommonAppsDtoArgs{
//					AppsConfigs: segment.ApplicationSegmentInspectionCommonAppsDtoAppsConfigArray{
//						&segment.ApplicationSegmentInspectionCommonAppsDtoAppsConfigArgs{
...
func NewApplicationSegmentInspection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Segment/applicationSegmentInspection:ApplicationSegmentInspection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSegmentInspection(ctx *pulumi.Context,
	...
	var resource ApplicationSegmentInspection
	err := ctx.ReadResource("zpa:Segment/applicationSegmentInspection:ApplicationSegmentInspection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
