...
//			_, err := Connector.GetAppConnectorGroup(ctx, &connector.GetAppConnectorGroupArgs{
...
func GetAppConnectorGroup(ctx *pulumi.Context, args *GetAppConnectorGroupArgs, opts ...pulumi.InvokeOption) (*GetAppConnectorGroupResult, error) {
	...
	err := ctx.Invoke("zpa:Connector/getAppConnectorGroup:getAppConnectorGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
