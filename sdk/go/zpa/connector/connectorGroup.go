...
//			_, err := Connector.NewConnectorGroup(ctx, "example", &Connector.ConnectorGroupArgs{
...
func NewConnectorGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Connector/connectorGroup:ConnectorGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectorGroup(ctx *pulumi.Context,
	...
	var resource ConnectorGroup
	err := ctx.ReadResource("zpa:Connector/connectorGroup:ConnectorGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
