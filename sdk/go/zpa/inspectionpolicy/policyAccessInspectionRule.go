...
func NewPolicyAccessInspectionRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:InspectionPolicy/policyAccessInspectionRule:PolicyAccessInspectionRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyAccessInspectionRule(ctx *pulumi.Context,
	...
	var resource PolicyAccessInspectionRule
	err := ctx.ReadResource("zpa:InspectionPolicy/policyAccessInspectionRule:PolicyAccessInspectionRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
