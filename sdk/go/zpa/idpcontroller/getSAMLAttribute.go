...
//			_, err := idpController.GetSAMLAttribute(ctx, &idpcontroller.GetSAMLAttributeArgs{
...
func GetSAMLAttribute(ctx *pulumi.Context, args *GetSAMLAttributeArgs, opts ...pulumi.InvokeOption) (*GetSAMLAttributeResult, error) {
	...
	err := ctx.Invoke("zpa:idpController/getSAMLAttribute:getSAMLAttribute", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
