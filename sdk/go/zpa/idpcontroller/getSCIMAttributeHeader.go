...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/idpController"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := idpController.GetSCIMAttributeHeader(ctx, &idpcontroller.GetSCIMAttributeHeaderArgs{
...
func GetSCIMAttributeHeader(ctx *pulumi.Context, args *GetSCIMAttributeHeaderArgs, opts ...pulumi.InvokeOption) (*GetSCIMAttributeHeaderResult, error) {
	...
	err := ctx.Invoke("zpa:idpController/getSCIMAttributeHeader:getSCIMAttributeHeader", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
