...
//			_, err := idpController.GetIdPController(ctx, &idpcontroller.GetIdPControllerArgs{
...
func GetIdPController(ctx *pulumi.Context, args *GetIdPControllerArgs, opts ...pulumi.InvokeOption) (*GetIdPControllerResult, error) {
	...
	err := ctx.Invoke("zpa:idpController/getIdPController:getIdPController", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
