...
//			example, err := Inspection.GetInspectionPredefinedControls(ctx, &inspection.GetInspectionPredefinedControlsArgs{
...
func GetInspectionPredefinedControls(ctx *pulumi.Context, args *GetInspectionPredefinedControlsArgs, opts ...pulumi.InvokeOption) (*GetInspectionPredefinedControlsResult, error) {
	...
	err := ctx.Invoke("zpa:Inspection/getInspectionPredefinedControls:getInspectionPredefinedControls", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
