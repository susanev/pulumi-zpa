...
//			_, err := Inspection.GetInspectionAllPredefinedControls(ctx, &inspection.GetInspectionAllPredefinedControlsArgs{
...
func GetInspectionAllPredefinedControls(ctx *pulumi.Context, args *GetInspectionAllPredefinedControlsArgs, opts ...pulumi.InvokeOption) (*GetInspectionAllPredefinedControlsResult, error) {
	...
	err := ctx.Invoke("zpa:Inspection/getInspectionAllPredefinedControls:getInspectionAllPredefinedControls", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
