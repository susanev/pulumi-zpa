...
func NewInspectionCustomControls(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Inspection/inspectionCustomControls:InspectionCustomControls", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInspectionCustomControls(ctx *pulumi.Context,
	...
	var resource InspectionCustomControls
	err := ctx.ReadResource("zpa:Inspection/inspectionCustomControls:InspectionCustomControls", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
