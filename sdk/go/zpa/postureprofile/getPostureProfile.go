...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/postureProfile"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := postureProfile.GetPostureProfile(ctx, &postureprofile.GetPostureProfileArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			example1, err := postureProfile.GetPostureProfile(ctx, &postureprofile.GetPostureProfileArgs{
//				Name: pulumi.StringRef("CrowdStrike_ZPA_ZTA_40 (zscalertwo.net)"),
//			}, nil)
//			if err != nil {
//				return err
...
func GetPostureProfile(ctx *pulumi.Context, args *GetPostureProfileArgs, opts ...pulumi.InvokeOption) (*GetPostureProfileResult, error) {
	...
	err := ctx.Invoke("zpa:postureProfile/getPostureProfile:getPostureProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
