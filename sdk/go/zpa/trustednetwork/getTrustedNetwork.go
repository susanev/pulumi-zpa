...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/trustedNetwork"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := trustedNetwork.GetTrustedNetwork(ctx, &trustednetwork.GetTrustedNetworkArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			example1, err := trustedNetwork.GetTrustedNetwork(ctx, &trustednetwork.GetTrustedNetworkArgs{
...
func GetTrustedNetwork(ctx *pulumi.Context, args *GetTrustedNetworkArgs, opts ...pulumi.InvokeOption) (*GetTrustedNetworkResult, error) {
	...
	err := ctx.Invoke("zpa:trustedNetwork/getTrustedNetwork:getTrustedNetwork", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
