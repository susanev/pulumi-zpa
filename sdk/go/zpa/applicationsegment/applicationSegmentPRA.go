...
func NewApplicationSegmentPRA(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:ApplicationSegment/applicationSegmentPRA:ApplicationSegmentPRA", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSegmentPRA(ctx *pulumi.Context,
	...
	var resource ApplicationSegmentPRA
	err := ctx.ReadResource("zpa:ApplicationSegment/applicationSegmentPRA:ApplicationSegmentPRA", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
