...
func NewApplicationSegmentBrowserAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:ApplicationSegment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationSegmentBrowserAccess(ctx *pulumi.Context,
	...
	var resource ApplicationSegmentBrowserAccess
	err := ctx.ReadResource("zpa:ApplicationSegment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
