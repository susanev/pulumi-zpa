...
func NewPolicyAccessForwardingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:ForwardPolicy/policyAccessForwardingRule:PolicyAccessForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyAccessForwardingRule(ctx *pulumi.Context,
	...
	var resource PolicyAccessForwardingRule
	err := ctx.ReadResource("zpa:ForwardPolicy/policyAccessForwardingRule:PolicyAccessForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o PolicyAccessForwardingRuleOutput) ZpnInspectionProfileId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PolicyAccessForwardingRule) pulumi.StringPtrOutput { return v.ZpnInspectionProfileId }).(pulumi.StringPtrOutput)
}
