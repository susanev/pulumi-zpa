...
//			_, err := SegmentGroup.NewSegmentGroup(ctx, "testSegmentGroup", &SegmentGroup.SegmentGroupArgs{
...
func NewSegmentGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:SegmentGroup/segmentGroup:SegmentGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSegmentGroup(ctx *pulumi.Context,
	...
	var resource SegmentGroup
	err := ctx.ReadResource("zpa:SegmentGroup/segmentGroup:SegmentGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// (Optional)
func (o SegmentGroupOutput) ConfigSpace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SegmentGroup) pulumi.StringPtrOutput { return v.ConfigSpace }).(pulumi.StringPtrOutput)
}
