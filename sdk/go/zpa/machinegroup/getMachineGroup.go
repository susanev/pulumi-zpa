...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/machineGroup"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := machineGroup.GetMachineGroup(ctx, &machinegroup.GetMachineGroupArgs{
...
func GetMachineGroup(ctx *pulumi.Context, args *GetMachineGroupArgs, opts ...pulumi.InvokeOption) (*GetMachineGroupResult, error) {
	...
	err := ctx.Invoke("zpa:machineGroup/getMachineGroup:getMachineGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
