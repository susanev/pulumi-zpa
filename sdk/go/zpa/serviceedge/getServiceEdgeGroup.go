...
//			_, err := ServiceEdge.GetServiceEdgeGroup(ctx, &serviceedge.GetServiceEdgeGroupArgs{
...
func LookupServiceEdgeGroup(ctx *pulumi.Context, args *LookupServiceEdgeGroupArgs, opts ...pulumi.InvokeOption) (*LookupServiceEdgeGroupResult, error) {
	...
	err := ctx.Invoke("zpa:ServiceEdge/getServiceEdgeGroup:getServiceEdgeGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
