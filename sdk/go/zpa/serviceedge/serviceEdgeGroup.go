...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/ServiceEdge"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := ServiceEdge.NewServiceEdgeGroup(ctx, "serviceEdgeGroupSjc", &ServiceEdge.ServiceEdgeGroupArgs{
...
//				TrustedNetworks: serviceedge.ServiceEdgeGroupTrustedNetworkArray{
//					&serviceedge.ServiceEdgeGroupTrustedNetworkArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := ServiceEdge.NewServiceEdgeGroup(ctx, "serviceEdgeGroupNyc", &ServiceEdge.ServiceEdgeGroupArgs{
...
func NewServiceEdgeGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:ServiceEdge/serviceEdgeGroup:ServiceEdgeGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEdgeGroup(ctx *pulumi.Context,
	...
	var resource ServiceEdgeGroup
	err := ctx.ReadResource("zpa:ServiceEdge/serviceEdgeGroup:ServiceEdgeGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
