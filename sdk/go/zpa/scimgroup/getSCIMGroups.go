...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/scimGroup"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := scimGroup.GetSCIMGroups(ctx, &scimgroup.GetSCIMGroupsArgs{
...
func GetSCIMGroups(ctx *pulumi.Context, args *GetSCIMGroupsArgs, opts ...pulumi.InvokeOption) (*GetSCIMGroupsResult, error) {
	...
	err := ctx.Invoke("zpa:scimGroup/getSCIMGroups:getSCIMGroups", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
