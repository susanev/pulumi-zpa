...
func NewApplicationServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:Server/applicationServer:ApplicationServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationServer(ctx *pulumi.Context,
	...
	var resource ApplicationServer
	err := ctx.ReadResource("zpa:Server/applicationServer:ApplicationServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
