...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/zscaler/pulumi-zpa/sdk/go/zpa/ProvisioningKey"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := ProvisioningKey.GetProvisioningKey(ctx, &provisioningkey.GetProvisioningKeyArgs{
...
func LookupProvisioningKey(ctx *pulumi.Context, args *LookupProvisioningKeyArgs, opts ...pulumi.InvokeOption) (*LookupProvisioningKeyResult, error) {
	...
	err := ctx.Invoke("zpa:ProvisioningKey/getProvisioningKey:getProvisioningKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
