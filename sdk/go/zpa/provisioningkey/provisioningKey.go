...
func NewProvisioningKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zpa:ProvisioningKey/provisioningKey:ProvisioningKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProvisioningKey(ctx *pulumi.Context,
	...
	var resource ProvisioningKey
	err := ctx.ReadResource("zpa:ProvisioningKey/provisioningKey:ProvisioningKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Read only property. Applicable only for GET calls, ignored in PUT/POST calls.
func (o ProvisioningKeyOutput) EnrollmentCertName() pulumi.StringOutput {
	return o.ApplyT(func(v *ProvisioningKey) pulumi.StringOutput { return v.EnrollmentCertName }).(pulumi.StringOutput)
}
...
// read only field. Ignored in PUT/POST calls.
func (o ProvisioningKeyOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *ProvisioningKey) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}
