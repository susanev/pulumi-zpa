...
namespace zscaler.PulumiPackage.Zpa
{
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:index/zPAApplicationSegmentInspection:ZPAApplicationSegmentInspection")]
    public partial class ZPAApplicationSegmentInspection : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.ZPAApplicationSegmentInspectionCommonAppsDto> CommonAppsDto { get; private set; } = null!;
        ...
        /// </summary>
        [Output("serverGroups")]
        public Output<ImmutableArray<Outputs.ZPAApplicationSegmentInspectionServerGroup>> ServerGroups { get; private set; } = null!;
        ...
        public ZPAApplicationSegmentInspection(string name, ZPAApplicationSegmentInspectionArgs args, CustomResourceOptions? options = null)
            : base("zpa:index/zPAApplicationSegmentInspection:ZPAApplicationSegmentInspection", name, args ?? new ZPAApplicationSegmentInspectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZPAApplicationSegmentInspection(string name, Input<string> id, ZPAApplicationSegmentInspectionState? state = null, CustomResourceOptions? options = null)
            : base("zpa:index/zPAApplicationSegmentInspection:ZPAApplicationSegmentInspection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ZPAApplicationSegmentInspection Get(string name, Input<string> id, ZPAApplicationSegmentInspectionState? state = null, CustomResourceOptions? options = null)
        {
            return new ZPAApplicationSegmentInspection(name, id, state, options);
        }
    }

    public sealed class ZPAApplicationSegmentInspectionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Optional) Indicates whether users can bypass ZPA to access applications.
        /// </summary>
        ...
        /// </summary>
        [Input("commonAppsDto")]
        public Input<Inputs.ZPAApplicationSegmentInspectionCommonAppsDtoArgs>? CommonAppsDto { get; set; }
        ...
        private InputList<Inputs.ZPAApplicationSegmentInspectionServerGroupArgs>? _serverGroups;

        /// <summary>
        /// List of Server Group IDs
        /// </summary>
        public InputList<Inputs.ZPAApplicationSegmentInspectionServerGroupArgs> ServerGroups
        {
            get => _serverGroups ?? (_serverGroups = new InputList<Inputs.ZPAApplicationSegmentInspectionServerGroupArgs>());
        ...
        public ZPAApplicationSegmentInspectionArgs()
        {
        }
        public static new ZPAApplicationSegmentInspectionArgs Empty => new ZPAApplicationSegmentInspectionArgs();
    }

    public sealed class ZPAApplicationSegmentInspectionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Optional) Indicates whether users can bypass ZPA to access applications.
        /// </summary>
        ...
        /// </summary>
        [Input("commonAppsDto")]
        public Input<Inputs.ZPAApplicationSegmentInspectionCommonAppsDtoGetArgs>? CommonAppsDto { get; set; }
        ...
        [Input("serverGroups")]
        private InputList<Inputs.ZPAApplicationSegmentInspectionServerGroupGetArgs>? _serverGroups;

        /// <summary>
        /// List of Server Group IDs
        /// </summary>
        public InputList<Inputs.ZPAApplicationSegmentInspectionServerGroupGetArgs> ServerGroups
        {
            get => _serverGroups ?? (_serverGroups = new InputList<Inputs.ZPAApplicationSegmentInspectionServerGroupGetArgs>());
            set => _serverGroups = value;
        }
        ...
        public ZPAApplicationSegmentInspectionState()
        {
        }
        public static new ZPAApplicationSegmentInspectionState Empty => new ZPAApplicationSegmentInspectionState();
    }
}
