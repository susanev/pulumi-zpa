...
namespace zscaler.PulumiPackage.Zpa.Server
{
    ...
    /// 
    /// ```sh
    ///  $ pulumi import zpa:Server/applicationServer:ApplicationServer example &lt;application_server_id&gt;
    /// ```
    /// 
    ///  or
    /// 
    /// ```sh
    ///  $ pulumi import zpa:Server/applicationServer:ApplicationServer example &lt;application_server_name&gt;
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:Server/applicationServer:ApplicationServer")]
    public partial class ApplicationServer : global::Pulumi.CustomResource
    {
        ...
        public ApplicationServer(string name, ApplicationServerArgs args, CustomResourceOptions? options = null)
            : base("zpa:Server/applicationServer:ApplicationServer", name, args ?? new ApplicationServerArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationServer(string name, Input<string> id, ApplicationServerState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Server/applicationServer:ApplicationServer", name, state, MakeResourceOptions(options, id))
        {
        }
