...
namespace zscaler.PulumiPackage.Zpa.IdpController
{
    public static class GetSCIMGroups
    {
        ...
        /// {
        ///     var engineering = Zpa.IdpController.GetSCIMGroups.Invoke(new()
        ///     {
        ///         IdpName = "idp_name",
        ///         Name = "Engineering",
        ///     });
        ...
        public static Task<GetSCIMGroupsResult> InvokeAsync(GetSCIMGroupsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSCIMGroupsResult>("zpa:idpController/getSCIMGroups:getSCIMGroups", args ?? new GetSCIMGroupsArgs(), options.WithDefaults());
        ...
        public static Output<GetSCIMGroupsResult> Invoke(GetSCIMGroupsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSCIMGroupsResult>("zpa:idpController/getSCIMGroups:getSCIMGroups", args ?? new GetSCIMGroupsInvokeArgs(), options.WithDefaults());
    }
