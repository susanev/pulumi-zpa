...
{
    public static class GetZPALSSClientTypes
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetZPALSSClientTypesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetZPALSSClientTypesResult>("zpa:index/getZPALSSClientTypes:getZPALSSClientTypes", InvokeArgs.Empty, options.WithDefaults());
    }


    [OutputType]
    public sealed class GetZPALSSClientTypesResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetZPALSSClientTypesResult(
            string id,
