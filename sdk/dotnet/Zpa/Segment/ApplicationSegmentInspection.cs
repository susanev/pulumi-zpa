...
namespace zscaler.PulumiPackage.Zpa.Segment
{
    ...
    ///     });
    /// 
    ///     var @this = new Zpa.Segment.ApplicationSegmentInspection("this", new()
    ///     {
    ...
    ///         ServerGroups = new[]
    ///         {
    ///             new Zpa.Segment.Inputs.ApplicationSegmentInspectionServerGroupArgs
    ///             {
    ///                 Ids = new[]
    ///                 {
    ...
    ///             },
    ///         },
    ///         CommonAppsDto = new Zpa.Segment.Inputs.ApplicationSegmentInspectionCommonAppsDtoArgs
    ///         {
    ///             AppsConfigs = new[]
    ///             {
    ///                 new Zpa.Segment.Inputs.ApplicationSegmentInspectionCommonAppsDtoAppsConfigArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:Segment/applicationSegmentInspection:ApplicationSegmentInspection")]
    public partial class ApplicationSegmentInspection : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSegmentInspection(string name, ApplicationSegmentInspectionArgs args, CustomResourceOptions? options = null)
            : base("zpa:Segment/applicationSegmentInspection:ApplicationSegmentInspection", name, args ?? new ApplicationSegmentInspectionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationSegmentInspection(string name, Input<string> id, ApplicationSegmentInspectionState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Segment/applicationSegmentInspection:ApplicationSegmentInspection", name, state, MakeResourceOptions(options, id))
        {
        }
