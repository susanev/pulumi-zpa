...
namespace zscaler.PulumiPackage.Zpa.Segment
{
    ...
    /// {
    ///     var @this = new Zpa.Segment.ApplicationSegmentPRA("this", new()
    ///     {
    ...
    ///         ServerGroups = new[]
    ///         {
    ///             new Zpa.Segment.Inputs.ApplicationSegmentPRAServerGroupArgs
    ///             {
    ///                 Ids = new[]
    ///                 {
    ...
    ///             },
    ///         },
    ///         CommonAppsDto = new Zpa.Segment.Inputs.ApplicationSegmentPRACommonAppsDtoArgs
    ///         {
    ///             AppsConfigs = new[]
    ///             {
    ///                 new Zpa.Segment.Inputs.ApplicationSegmentPRACommonAppsDtoAppsConfigArgs
    ///                 {
    ///                     Name = "ssh_pra",
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA")]
    public partial class ApplicationSegmentPRA : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSegmentPRA(string name, ApplicationSegmentPRAArgs args, CustomResourceOptions? options = null)
            : base("zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA", name, args ?? new ApplicationSegmentPRAArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationSegmentPRA(string name, Input<string> id, ApplicationSegmentPRAState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA", name, state, MakeResourceOptions(options, id))
        {
        }
