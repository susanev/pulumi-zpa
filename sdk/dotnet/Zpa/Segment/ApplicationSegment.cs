...
namespace zscaler.PulumiPackage.Zpa.Segment
{
    ...
    /// 
    /// ```sh
    ///  $ pulumi import zpa:Segment/applicationSegment:ApplicationSegment example &lt;application_segment_id&gt;
    /// ```
    /// 
    ///  or
    /// 
    /// ```sh
    ///  $ pulumi import zpa:Segment/applicationSegment:ApplicationSegment example &lt;application_segment_name&gt;
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:Segment/applicationSegment:ApplicationSegment")]
    public partial class ApplicationSegment : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSegment(string name, ApplicationSegmentArgs args, CustomResourceOptions? options = null)
            : base("zpa:Segment/applicationSegment:ApplicationSegment", name, args ?? new ApplicationSegmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationSegment(string name, Input<string> id, ApplicationSegmentState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Segment/applicationSegment:ApplicationSegment", name, state, MakeResourceOptions(options, id))
        {
        }
