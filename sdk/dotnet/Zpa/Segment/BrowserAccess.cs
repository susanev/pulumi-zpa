...
{
    [ZpaResourceType("zpa:Segment/browserAccess:BrowserAccess")]
    public partial class BrowserAccess : global::Pulumi.CustomResource
    {
        ...
        public BrowserAccess(string name, BrowserAccessArgs args, CustomResourceOptions? options = null)
            : base("zpa:Segment/browserAccess:BrowserAccess", name, args ?? new BrowserAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BrowserAccess(string name, Input<string> id, BrowserAccessState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Segment/browserAccess:BrowserAccess", name, state, MakeResourceOptions(options, id))
        {
        }
