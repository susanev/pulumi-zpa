...
namespace zscaler.PulumiPackage.Zpa.Segment
{
    public static class GetApplicationSegmentPRA
    {
        ...
        /// {
        ///     var @this = Zpa.Segment.GetApplicationSegmentPRA.Invoke(new()
        ///     {
        ///         Name = "PRA_Example",
        ///     });
        /// 
        ...
        public static Task<GetApplicationSegmentPRAResult> InvokeAsync(GetApplicationSegmentPRAArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationSegmentPRAResult>("zpa:Segment/getApplicationSegmentPRA:getApplicationSegmentPRA", args ?? new GetApplicationSegmentPRAArgs(), options.WithDefaults());
        ...
        public static Output<GetApplicationSegmentPRAResult> Invoke(GetApplicationSegmentPRAInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationSegmentPRAResult>("zpa:Segment/getApplicationSegmentPRA:getApplicationSegmentPRA", args ?? new GetApplicationSegmentPRAInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetApplicationSegmentPRAArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tcpPortRanges")]
        private List<Inputs.GetApplicationSegmentPRATcpPortRangeArgs>? _tcpPortRanges;
        ...
        /// * `to:`
        /// </summary>
        public List<Inputs.GetApplicationSegmentPRATcpPortRangeArgs> TcpPortRanges
        {
            get => _tcpPortRanges ?? (_tcpPortRanges = new List<Inputs.GetApplicationSegmentPRATcpPortRangeArgs>());
            set => _tcpPortRanges = value;
        }

        [Input("udpPortRanges")]
        private List<Inputs.GetApplicationSegmentPRAUdpPortRangeArgs>? _udpPortRanges;
        ...
        /// * `to:`
        /// </summary>
        public List<Inputs.GetApplicationSegmentPRAUdpPortRangeArgs> UdpPortRanges
        {
            get => _udpPortRanges ?? (_udpPortRanges = new List<Inputs.GetApplicationSegmentPRAUdpPortRangeArgs>());
    ...
    public sealed class GetApplicationSegmentPRAInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tcpPortRanges")]
        private InputList<Inputs.GetApplicationSegmentPRATcpPortRangeInputArgs>? _tcpPortRanges;
        ...
        /// * `to:`
        /// </summary>
        public InputList<Inputs.GetApplicationSegmentPRATcpPortRangeInputArgs> TcpPortRanges
        {
            get => _tcpPortRanges ?? (_tcpPortRanges = new InputList<Inputs.GetApplicationSegmentPRATcpPortRangeInputArgs>());
            set => _tcpPortRanges = value;
        }

        [Input("udpPortRanges")]
        private InputList<Inputs.GetApplicationSegmentPRAUdpPortRangeInputArgs>? _udpPortRanges;
        ...
        /// * `to:`
        /// </summary>
        public InputList<Inputs.GetApplicationSegmentPRAUdpPortRangeInputArgs> UdpPortRanges
        {
            get => _udpPortRanges ?? (_udpPortRanges = new InputList<Inputs.GetApplicationSegmentPRAUdpPortRangeInputArgs>());
            set => _udpPortRanges = value;
        }
