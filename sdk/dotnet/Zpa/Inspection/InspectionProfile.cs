...
namespace zscaler.PulumiPackage.Zpa.Inspection
{
    ...
    /// </summary>
    [ZpaResourceType("zpa:Inspection/inspectionProfile:InspectionProfile")]
    public partial class InspectionProfile : global::Pulumi.CustomResource
    {
        ...
        public InspectionProfile(string name, InspectionProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("zpa:Inspection/inspectionProfile:InspectionProfile", name, args ?? new InspectionProfileArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InspectionProfile(string name, Input<string> id, InspectionProfileState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Inspection/inspectionProfile:InspectionProfile", name, state, MakeResourceOptions(options, id))
        {
        }
