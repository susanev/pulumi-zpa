...
namespace zscaler.PulumiPackage.Zpa.AppConnectorGroup
{
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:AppConnectorGroup/connectorGroup:ConnectorGroup")]
    public partial class ConnectorGroup : global::Pulumi.CustomResource
    {
        ...
        public ConnectorGroup(string name, ConnectorGroupArgs args, CustomResourceOptions? options = null)
            : base("zpa:AppConnectorGroup/connectorGroup:ConnectorGroup", name, args ?? new ConnectorGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorGroup(string name, Input<string> id, ConnectorGroupState? state = null, CustomResourceOptions? options = null)
            : base("zpa:AppConnectorGroup/connectorGroup:ConnectorGroup", name, state, MakeResourceOptions(options, id))
        {
        }
