...
namespace zscaler.PulumiPackage.Zpa.ApplicationSegment
{
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:ApplicationSegment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess")]
    public partial class ApplicationSegmentBrowserAccess : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSegmentBrowserAccess(string name, ApplicationSegmentBrowserAccessArgs args, CustomResourceOptions? options = null)
            : base("zpa:ApplicationSegment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess", name, args ?? new ApplicationSegmentBrowserAccessArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationSegmentBrowserAccess(string name, Input<string> id, ApplicationSegmentBrowserAccessState? state = null, CustomResourceOptions? options = null)
            : base("zpa:ApplicationSegment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess", name, state, MakeResourceOptions(options, id))
        {
        }
