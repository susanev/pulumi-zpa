...
namespace zscaler.PulumiPackage.Zpa.ApplicationSegment
{
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:ApplicationSegment/applicationSegmentPRA:ApplicationSegmentPRA")]
    public partial class ApplicationSegmentPRA : global::Pulumi.CustomResource
    {
        ...
        public ApplicationSegmentPRA(string name, ApplicationSegmentPRAArgs args, CustomResourceOptions? options = null)
            : base("zpa:ApplicationSegment/applicationSegmentPRA:ApplicationSegmentPRA", name, args ?? new ApplicationSegmentPRAArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationSegmentPRA(string name, Input<string> id, ApplicationSegmentPRAState? state = null, CustomResourceOptions? options = null)
            : base("zpa:ApplicationSegment/applicationSegmentPRA:ApplicationSegmentPRA", name, state, MakeResourceOptions(options, id))
        {
        }
