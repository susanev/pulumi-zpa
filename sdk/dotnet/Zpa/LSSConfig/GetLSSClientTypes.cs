...
namespace zscaler.PulumiPackage.Zpa.LSSConfig
{
    public static class GetLSSClientTypes
    {
        ...
        /// {
        ///     var example = Zpa.LSSConfig.GetLSSClientTypes.Invoke();
        /// 
        /// });
        /// ```
        /// {{% /example %}}
        ...
        public static Task<GetLSSClientTypesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLSSClientTypesResult>("zpa:LSSConfig/getLSSClientTypes:getLSSClientTypes", InvokeArgs.Empty, options.WithDefaults());
    }
