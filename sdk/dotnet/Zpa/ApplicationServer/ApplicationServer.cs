...
namespace zscaler.PulumiPackage.Zpa.ApplicationServer
{
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:ApplicationServer/applicationServer:ApplicationServer")]
    public partial class ApplicationServer : global::Pulumi.CustomResource
    {
        ...
        public ApplicationServer(string name, ApplicationServerArgs args, CustomResourceOptions? options = null)
            : base("zpa:ApplicationServer/applicationServer:ApplicationServer", name, args ?? new ApplicationServerArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApplicationServer(string name, Input<string> id, ApplicationServerState? state = null, CustomResourceOptions? options = null)
            : base("zpa:ApplicationServer/applicationServer:ApplicationServer", name, state, MakeResourceOptions(options, id))
        {
        }
