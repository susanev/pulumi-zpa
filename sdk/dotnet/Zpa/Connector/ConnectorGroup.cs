...
namespace zscaler.PulumiPackage.Zpa.Connector
{
    ...
    ///     var example = new Zpa.Connector.ConnectorGroup("example", new()
    ///     {
    ...
    /// 
    /// ```sh
    ///  $ pulumi import zpa:Connector/connectorGroup:ConnectorGroup example &lt;app_connector_group_id&gt;
    /// ```
    /// 
    ///  or
    /// 
    /// ```sh
    ///  $ pulumi import zpa:Connector/connectorGroup:ConnectorGroup example &lt;app_connector_group_name&gt;
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:Connector/connectorGroup:ConnectorGroup")]
    public partial class ConnectorGroup : global::Pulumi.CustomResource
    {
        ...
        public ConnectorGroup(string name, ConnectorGroupArgs args, CustomResourceOptions? options = null)
            : base("zpa:Connector/connectorGroup:ConnectorGroup", name, args ?? new ConnectorGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorGroup(string name, Input<string> id, ConnectorGroupState? state = null, CustomResourceOptions? options = null)
            : base("zpa:Connector/connectorGroup:ConnectorGroup", name, state, MakeResourceOptions(options, id))
        {
        }
