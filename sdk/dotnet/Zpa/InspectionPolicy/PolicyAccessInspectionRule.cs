...
namespace zscaler.PulumiPackage.Zpa.InspectionPolicy
{
    [ZpaResourceType("zpa:InspectionPolicy/policyAccessInspectionRule:PolicyAccessInspectionRule")]
    public partial class PolicyAccessInspectionRule : global::Pulumi.CustomResource
    {
        ...
        public PolicyAccessInspectionRule(string name, PolicyAccessInspectionRuleArgs? args = null, CustomResourceOptions? options = null)
            : base("zpa:InspectionPolicy/policyAccessInspectionRule:PolicyAccessInspectionRule", name, args ?? new PolicyAccessInspectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PolicyAccessInspectionRule(string name, Input<string> id, PolicyAccessInspectionRuleState? state = null, CustomResourceOptions? options = null)
            : base("zpa:InspectionPolicy/policyAccessInspectionRule:PolicyAccessInspectionRule", name, state, MakeResourceOptions(options, id))
        {
        }
