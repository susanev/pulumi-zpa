...
namespace zscaler.PulumiPackage.Zpa.TimeoutPolicy
{
    [ZpaResourceType("zpa:TimeoutPolicy/policyAccessTimeOutRule:PolicyAccessTimeOutRule")]
    public partial class PolicyAccessTimeOutRule : global::Pulumi.CustomResource
    {
        ...
        public PolicyAccessTimeOutRule(string name, PolicyAccessTimeOutRuleArgs? args = null, CustomResourceOptions? options = null)
            : base("zpa:TimeoutPolicy/policyAccessTimeOutRule:PolicyAccessTimeOutRule", name, args ?? new PolicyAccessTimeOutRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PolicyAccessTimeOutRule(string name, Input<string> id, PolicyAccessTimeOutRuleState? state = null, CustomResourceOptions? options = null)
            : base("zpa:TimeoutPolicy/policyAccessTimeOutRule:PolicyAccessTimeOutRule", name, state, MakeResourceOptions(options, id))
        {
        }
