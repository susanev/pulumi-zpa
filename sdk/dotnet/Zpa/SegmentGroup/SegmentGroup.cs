...
namespace zscaler.PulumiPackage.Zpa.SegmentGroup
{
    ...
    ///     var testSegmentGroup = new Zpa.SegmentGroup.SegmentGroup("testSegmentGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ZpaResourceType("zpa:SegmentGroup/segmentGroup:SegmentGroup")]
    public partial class SegmentGroup : global::Pulumi.CustomResource
    {
        ...
        public SegmentGroup(string name, SegmentGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("zpa:SegmentGroup/segmentGroup:SegmentGroup", name, args ?? new SegmentGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SegmentGroup(string name, Input<string> id, SegmentGroupState? state = null, CustomResourceOptions? options = null)
            : base("zpa:SegmentGroup/segmentGroup:SegmentGroup", name, state, MakeResourceOptions(options, id))
        {
        }
