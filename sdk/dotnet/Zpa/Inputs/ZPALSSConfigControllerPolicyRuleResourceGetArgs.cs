...
namespace zscaler.PulumiPackage.Zpa.Inputs
{
    ...
    public sealed class ZPALSSConfigControllerPolicyRuleResourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Optional)
        /// </summary>
        ...
        [Input("conditions")]
        private InputList<Inputs.ZPALSSConfigControllerPolicyRuleResourceConditionGetArgs>? _conditions;

        /// <summary>
        /// (Optional)
        /// </summary>
        public InputList<Inputs.ZPALSSConfigControllerPolicyRuleResourceConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ZPALSSConfigControllerPolicyRuleResourceConditionGetArgs>());
        ...
        public ZPALSSConfigControllerPolicyRuleResourceGetArgs()
        {
        }
        public static new ZPALSSConfigControllerPolicyRuleResourceGetArgs Empty => new ZPALSSConfigControllerPolicyRuleResourceGetArgs();
    }
}
