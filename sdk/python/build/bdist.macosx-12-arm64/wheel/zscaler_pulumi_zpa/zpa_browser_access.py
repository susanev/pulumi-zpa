...
__all__ = ['ZPABrowserAccessArgs', 'ZPABrowserAccess']

@pulumi.input_type
class ZPABrowserAccessArgs:
    def __init__(__self__, *,
                 clientless_apps: pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessClientlessAppArgs']]],
                 domain_names: pulumi.Input[Sequence[pulumi.Input[str]]],
                 segment_group_id: pulumi.Input[str],
                 server_groups: pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]] server_groups: List of the server group IDs.
    ...
    def clientless_apps(self) -> pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessClientlessAppArgs']]]:
        return pulumi.get(self, "clientless_apps")

    @clientless_apps.setter
    def clientless_apps(self, value: pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessClientlessAppArgs']]]):
    ...
    def server_groups(self) -> pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]]:
        """
    ...
    def server_groups(self, value: pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]]):
...
@pulumi.input_type
class _ZPABrowserAccessState:
    def __init__(__self__, *,
                 bypass_type: Optional[pulumi.Input[str]] = None,
                 clientless_apps: Optional[pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessClientlessAppArgs']]]] = None,
                 config_space: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 ...
                 segment_group_name: Optional[pulumi.Input[str]] = None,
                 server_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]]] = None,
                 tcp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="clientlessApps")
    def clientless_apps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessClientlessAppArgs']]]]:
        return pulumi.get(self, "clientless_apps")

    @clientless_apps.setter
    def clientless_apps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessClientlessAppArgs']]]]):
        pulumi.set(self, "clientless_apps", value)
    ...
    @property
    @pulumi.getter(name="serverGroups")
    def server_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]]]:
        """
        List of the server group IDs.
        """
        return pulumi.get(self, "server_groups")
    ...
    @server_groups.setter
    def server_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPABrowserAccessServerGroupArgs']]]]):
        pulumi.set(self, "server_groups", value)
...
class ZPABrowserAccess(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 bypass_type: Optional[pulumi.Input[str]] = None,
                 clientless_apps: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPABrowserAccessClientlessAppArgs']]]]] = None,
                 config_space: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 domain_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 double_encrypt: Optional[pulumi.Input[bool]] = None,
                 ...
                 segment_group_id: Optional[pulumi.Input[str]] = None,
                 segment_group_name: Optional[pulumi.Input[str]] = None,
                 server_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPABrowserAccessServerGroupArgs']]]]] = None,
                 tcp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        Create a ZPABrowserAccess resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[bool] is_cname_enabled: Indicates if the Zscaler Client Connector (formerly Zscaler App or Z App) receives CNAME DNS records from the
               connectors.
        :param pulumi.Input[str] name: Name of the application.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPABrowserAccessServerGroupArgs']]]] server_groups: List of the server group IDs.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tcp_port_ranges: TCP port ranges used to access the app.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] udp_port_ranges: UDP port ranges used to access the app.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ZPABrowserAccessArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ZPABrowserAccess resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ZPABrowserAccessArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZPABrowserAccessArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZPABrowserAccessArgs.__new__(ZPABrowserAccessArgs)
        ...
        super(ZPABrowserAccess, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            server_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPABrowserAccessServerGroupArgs']]]]] = None,
            tcp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'ZPABrowserAccess':
        """
        ...
        __props__ = _ZPABrowserAccessState.__new__(_ZPABrowserAccessState)
        ...
        __props__.__dict__["tcp_port_ranges"] = tcp_port_ranges
        __props__.__dict__["udp_port_ranges"] = udp_port_ranges
        return ZPABrowserAccess(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="clientlessApps")
    def clientless_apps(self) -> pulumi.Output[Sequence['outputs.ZPABrowserAccessClientlessApp']]:
        return pulumi.get(self, "clientless_apps")
    ...
    @property
    @pulumi.getter(name="serverGroups")
    def server_groups(self) -> pulumi.Output[Sequence['outputs.ZPABrowserAccessServerGroup']]:
        """
        List of the server group IDs.
        """
        return pulumi.get(self, "server_groups")
