...
__all__ = ['ZPAPolicyAccessInspectionRuleArgs', 'ZPAPolicyAccessInspectionRule']

@pulumi.input_type
class ZPAPolicyAccessInspectionRuleArgs:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[str]] = None,
                 action_id: Optional[pulumi.Input[str]] = None,
                 bypass_default_rule: Optional[pulumi.Input[bool]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessInspectionRuleConditionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessInspectionRuleConditionArgs']]] conditions: This is for proviidng the set of conditions for the policy.
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessInspectionRuleConditionArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessInspectionRuleConditionArgs']]]]):
...
@pulumi.input_type
class _ZPAPolicyAccessInspectionRuleState:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[str]] = None,
                 action_id: Optional[pulumi.Input[str]] = None,
                 bypass_default_rule: Optional[pulumi.Input[bool]] = None,
...
class ZPAPolicyAccessInspectionRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 action_id: Optional[pulumi.Input[str]] = None,
                 bypass_default_rule: Optional[pulumi.Input[bool]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAPolicyAccessInspectionRuleConditionArgs']]]]] = None,
                 custom_msg: Optional[pulumi.Input[str]] = None,
                 default_rule: Optional[pulumi.Input[bool]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 lss_default_rule: Optional[pulumi.Input[bool]] = None,
                 ...
                 __props__=None):
        """
        Create a ZPAPolicyAccessInspectionRule resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] action: This is for providing the rule action.
        :param pulumi.Input[str] action_id: This field defines the description of the server.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAPolicyAccessInspectionRuleConditionArgs']]]] conditions: This is for proviidng the set of conditions for the policy.
        :param pulumi.Input[str] custom_msg: This is for providing a customer message for the user.
        :param pulumi.Input[bool] default_rule: This is for providing a customer message for the user.
        :param pulumi.Input[str] description: This is the description of the access policy.
        :param pulumi.Input[str] name: This is the name of the policy.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ZPAPolicyAccessInspectionRuleArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ZPAPolicyAccessInspectionRule resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ZPAPolicyAccessInspectionRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZPAPolicyAccessInspectionRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZPAPolicyAccessInspectionRuleArgs.__new__(ZPAPolicyAccessInspectionRuleArgs)
        ...
        super(ZPAPolicyAccessInspectionRule, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            reauth_timeout: Optional[pulumi.Input[str]] = None,
            rule_order: Optional[pulumi.Input[str]] = None,
            zpn_inspection_profile_id: Optional[pulumi.Input[str]] = None) -> 'ZPAPolicyAccessInspectionRule':
        """
        ...
        __props__ = _ZPAPolicyAccessInspectionRuleState.__new__(_ZPAPolicyAccessInspectionRuleState)
        ...
        __props__.__dict__["rule_order"] = rule_order
        __props__.__dict__["zpn_inspection_profile_id"] = zpn_inspection_profile_id
        return ZPAPolicyAccessInspectionRule(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def conditions(self) -> pulumi.Output[Sequence['outputs.ZPAPolicyAccessInspectionRuleCondition']]:
        """
        This is for proviidng the set of conditions for the policy.
        """
        return pulumi.get(self, "conditions")
