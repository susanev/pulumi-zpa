...
def get_scim_groups(id: Optional[str] = None,
    ...
    engineering = zpa.scimGroup.get_scim_groups(idp_name="idp_name",
        name="Engineering")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:scimGroup/getSCIMGroups:getSCIMGroups', __args__, opts=opts, typ=GetSCIMGroupsResult).value
