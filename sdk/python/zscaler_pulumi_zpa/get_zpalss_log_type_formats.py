...
__all__ = [
    'GetZPALSSLogTypeFormatsResult',
    'AwaitableGetZPALSSLogTypeFormatsResult',
    'get_zpalss_log_type_formats',
    'get_zpalss_log_type_formats_output',
]

@pulumi.output_type
class GetZPALSSLogTypeFormatsResult:
    """
...
class AwaitableGetZPALSSLogTypeFormatsResult(GetZPALSSLogTypeFormatsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZPALSSLogTypeFormatsResult(
            csv=self.csv,
            id=self.id,
            json=self.json,
...
def get_zpalss_log_type_formats(log_type: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZPALSSLogTypeFormatsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getZPALSSLogTypeFormats:getZPALSSLogTypeFormats', __args__, opts=opts, typ=GetZPALSSLogTypeFormatsResult).value

    return AwaitableGetZPALSSLogTypeFormatsResult(
        csv=__ret__.csv,
        id=__ret__.id,
        json=__ret__.json,
...
@_utilities.lift_output_func(get_zpalss_log_type_formats)
def get_zpalss_log_type_formats_output(log_type: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZPALSSLogTypeFormatsResult]:
    """
    Use the **zpa_lss_config_log_type_formats** data source to get information about all LSS log type formats in the Zscaler Private Access cloud. This data source is required when creating an LSS Config Controller resource.
