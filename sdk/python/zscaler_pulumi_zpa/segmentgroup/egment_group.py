...
__all__ = ['EgmentGroupArgs', 'EgmentGroup']

@pulumi.input_type
class EgmentGroupArgs:
    def __init__(__self__, *,
                 applications: Optional[pulumi.Input[Sequence[pulumi.Input['EgmentGroupApplicationArgs']]]] = None,
        ...
        """
        The set of arguments for constructing a EgmentGroup resource.
    ...
    @property
    @pulumi.getter
    def applications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EgmentGroupApplicationArgs']]]]:
        return pulumi.get(self, "applications")

    @applications.setter
    def applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EgmentGroupApplicationArgs']]]]):
...
class _EgmentGroupState:
    def __init__(__self__, *,
                 ...
                 tcp_keep_alive_enabled: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering EgmentGroup resources.
        :param pulumi.Input[str] config_space: (Optional)
        :param pulumi.Input[str] description: (Optional) Description of the segment group.
        :param pulumi.Input[bool] enabled: (Optional) Whether this segment group is enabled or not.
        :param pulumi.Input[str] name: (Required) Name of the segment group.
...
class EgmentGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 applications: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EgmentGroupApplicationArgs']]]]] = None,
                 config_space: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        test_segment_group = zpa.segment_group.EgmentGroup("testSegmentGroup",
        ...
        ```sh
         $ pulumi import zpa:SegmentGroup/egmentGroup:egmentGroup example <segment_group_id>
        ```

         or

        ```sh
         $ pulumi import zpa:SegmentGroup/egmentGroup:egmentGroup example <segment_group_name>
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[EgmentGroupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param EgmentGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EgmentGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EgmentGroupArgs.__new__(EgmentGroupArgs)
        ...
        super(EgmentGroup, __self__).__init__(
            'zpa:SegmentGroup/egmentGroup:egmentGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            policy_migrated: Optional[pulumi.Input[bool]] = None,
            tcp_keep_alive_enabled: Optional[pulumi.Input[str]] = None) -> 'EgmentGroup':
        """
        Get an existing EgmentGroup resource's state with the given name, id, and optional extra
        ...
        __props__ = _EgmentGroupState.__new__(_EgmentGroupState)
        ...
        __props__.__dict__["policy_migrated"] = policy_migrated
        __props__.__dict__["tcp_keep_alive_enabled"] = tcp_keep_alive_enabled
        return EgmentGroup(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def applications(self) -> pulumi.Output[Sequence['outputs.EgmentGroupApplication']]:
        return pulumi.get(self, "applications")
