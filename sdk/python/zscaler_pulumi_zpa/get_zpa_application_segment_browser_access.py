...
__all__ = [
    'GetZPAApplicationSegmentBrowserAccessResult',
    'AwaitableGetZPAApplicationSegmentBrowserAccessResult',
    'get_zpa_application_segment_browser_access',
    'get_zpa_application_segment_browser_access_output',
]

@pulumi.output_type
class GetZPAApplicationSegmentBrowserAccessResult:
    """
    ...
    def clientless_apps(self) -> Sequence['outputs.GetZPAApplicationSegmentBrowserAccessClientlessAppResult']:
    ...
    def server_groups(self) -> Sequence['outputs.GetZPAApplicationSegmentBrowserAccessServerGroupResult']:
...
class AwaitableGetZPAApplicationSegmentBrowserAccessResult(GetZPAApplicationSegmentBrowserAccessResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZPAApplicationSegmentBrowserAccessResult(
...
def get_zpa_application_segment_browser_access(id: Optional[str] = None,
                                               name: Optional[str] = None,
                                               tcp_port_ranges: Optional[Sequence[pulumi.InputType['GetZPAApplicationSegmentBrowserAccessTcpPortRangeArgs']]] = None,
                                               udp_port_ranges: Optional[Sequence[pulumi.InputType['GetZPAApplicationSegmentBrowserAccessUdpPortRangeArgs']]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZPAApplicationSegmentBrowserAccessResult:
    """
    ## Example Usage
    ...
    :param Sequence[pulumi.InputType['GetZPAApplicationSegmentBrowserAccessTcpPortRangeArgs']] tcp_port_ranges: (string) TCP port ranges used to access the app.
           * `from:`
           * `to:`
    :param Sequence[pulumi.InputType['GetZPAApplicationSegmentBrowserAccessUdpPortRangeArgs']] udp_port_ranges: (string) UDP port ranges used to access the app.
           * `from:`
           * `to:`
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getZPAApplicationSegmentBrowserAccess:getZPAApplicationSegmentBrowserAccess', __args__, opts=opts, typ=GetZPAApplicationSegmentBrowserAccessResult).value

    return AwaitableGetZPAApplicationSegmentBrowserAccessResult(
...
@_utilities.lift_output_func(get_zpa_application_segment_browser_access)
def get_zpa_application_segment_browser_access_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                                      name: Optional[pulumi.Input[Optional[str]]] = None,
                                                      tcp_port_ranges: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetZPAApplicationSegmentBrowserAccessTcpPortRangeArgs']]]]] = None,
                                                      udp_port_ranges: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetZPAApplicationSegmentBrowserAccessUdpPortRangeArgs']]]]] = None,
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZPAApplicationSegmentBrowserAccessResult]:
    """
    ## Example Usage
