...
class GetZPAInspectionProfileResult:
    ...
    def controls_infos(self) -> Sequence['outputs.GetZPAInspectionProfileControlsInfoResult']:
        """
    ...
    def predefined_controls(self) -> Sequence['outputs.GetZPAInspectionProfilePredefinedControlResult']:
        """
...
class AwaitableGetZPAInspectionProfileResult(GetZPAInspectionProfileResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZPAInspectionProfileResult(
...
def get_zpa_inspection_profile(id: Optional[str] = None,
                               name: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZPAInspectionProfileResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getZPAInspectionProfile:getZPAInspectionProfile', __args__, opts=opts, typ=GetZPAInspectionProfileResult).value

    return AwaitableGetZPAInspectionProfileResult(
        common_global_override_actions_config=__ret__.common_global_override_actions_config,
        controls_infos=__ret__.controls_infos,
        creation_time=__ret__.creation_time,
        custom_controls=__ret__.custom_controls,
        description=__ret__.description,
        global_control_actions=__ret__.global_control_actions,
        id=__ret__.id,
        incarnation_number=__ret__.incarnation_number,
        modified_by=__ret__.modified_by,
        modified_time=__ret__.modified_time,
        name=__ret__.name,
        paranoia_level=__ret__.paranoia_level,
        predefined_controls=__ret__.predefined_controls,
        predefined_controls_version=__ret__.predefined_controls_version)


@_utilities.lift_output_func(get_zpa_inspection_profile)
def get_zpa_inspection_profile_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                      name: Optional[pulumi.Input[Optional[str]]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZPAInspectionProfileResult]:
    """
    Use the **zpa_inspection_profile** data source to get information about an inspection profile in the Zscaler Private Access cloud. This resource can then be referenced in an inspection custom control resource.
