...
def get_app_connector_group(id: Optional[str] = None,
    ...
    foo = zpa.Connector.get_app_connector_group(name="DataCenter")
    ```
    ...
    foo = zpa.Connector.get_app_connector_group(id="123456789")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Connector/getAppConnectorGroup:getAppConnectorGroup', __args__, opts=opts, typ=GetAppConnectorGroupResult).value
