...
def get_application_segment_pra(id: Optional[str] = None,
    ...
    this = zpa.Segment.get_application_segment_pra(name="PRA_Example")
    ```
    ...
    this = zpa.Segment.get_application_segment_pra(id="123456789")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Segment/getApplicationSegmentPRA:getApplicationSegmentPRA', __args__, opts=opts, typ=GetApplicationSegmentPRAResult).value
