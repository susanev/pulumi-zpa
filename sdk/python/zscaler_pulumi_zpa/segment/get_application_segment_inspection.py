...
def get_application_segment_inspection(id: Optional[str] = None,
    ...
    this = zpa.Segment.get_application_segment_inspection(name="ZPA_Inspection_Example")
    ```
    ...
    this = zpa.Segment.get_application_segment_inspection(id="123456789")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Segment/getApplicationSegmentInspection:getApplicationSegmentInspection', __args__, opts=opts, typ=GetApplicationSegmentInspectionResult).value
