...
class ApplicationSegmentBrowserAccess(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_segment_group = zpa.segment_group.SegmentGroup("exampleSegmentGroup",
            description="Example",
            enabled=True)
        example_app_connector_group = zpa.Connector.get_app_connector_group(name="AWS-Connector")
        ...
        browser_access_apps = zpa.segment.ApplicationSegmentBrowserAccess("browserAccessApps",
            ...
            clientless_apps=[zpa.segment.ApplicationSegmentBrowserAccessClientlessAppArgs(
                name="sales.acme.com",
            ...
            server_groups=[zpa.segment.ApplicationSegmentBrowserAccessServerGroupArgs(
    ...
    def _internal_init(__self__,
        ...
        super(ApplicationSegmentBrowserAccess, __self__).__init__(
            'zpa:Segment/applicationSegmentBrowserAccess:ApplicationSegmentBrowserAccess',
            resource_name,
            __props__,
            opts)
