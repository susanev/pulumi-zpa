...
def get_application_segment_browser_access(id: Optional[str] = None,
    ...
    example = zpa.Segment.get_application_segment_browser_access(name="example")
    ```
    ...
    example = zpa.Segment.get_application_segment_browser_access(id="123456789")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Segment/getApplicationSegmentBrowserAccess:getApplicationSegmentBrowserAccess', __args__, opts=opts, typ=GetApplicationSegmentBrowserAccessResult).value
