...
class ApplicationSegmentPRA(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        this = zpa.segment.ApplicationSegmentPRA("this",
            ...
            server_groups=[zpa.segment.ApplicationSegmentPRAServerGroupArgs(
                ids=[zpa_server_group["this"]["id"]],
            )],
            common_apps_dto=zpa.segment.ApplicationSegmentPRACommonAppsDtoArgs(
                apps_configs=[
                    zpa.segment.ApplicationSegmentPRACommonAppsDtoAppsConfigArgs(
                        name="ssh_pra",
    ...
    def _internal_init(__self__,
        ...
        super(ApplicationSegmentPRA, __self__).__init__(
            'zpa:Segment/applicationSegmentPRA:ApplicationSegmentPRA',
            resource_name,
            __props__,
            opts)
