...
class ApplicationSegmentInspection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        this = zpa.segment.ApplicationSegmentInspection("this",
            ...
            server_groups=[zpa.segment.ApplicationSegmentInspectionServerGroupArgs(
                ids=[zpa_server_group["this"]["id"]],
            )],
            common_apps_dto=zpa.segment.ApplicationSegmentInspectionCommonAppsDtoArgs(
                apps_configs=[zpa.segment.ApplicationSegmentInspectionCommonAppsDtoAppsConfigArgs(
    ...
    def _internal_init(__self__,
        ...
        super(ApplicationSegmentInspection, __self__).__init__(
            'zpa:Segment/applicationSegmentInspection:ApplicationSegmentInspection',
            resource_name,
            __props__,
            opts)
