...
def get_application_segment(id: Optional[str] = None,
    ...
    this = zpa.Segment.get_application_segment(name="example")
    ```
    ...
    this = zpa.Segment.get_application_segment(id="123456789")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Segment/getApplicationSegment:getApplicationSegment', __args__, opts=opts, typ=GetApplicationSegmentResult).value
