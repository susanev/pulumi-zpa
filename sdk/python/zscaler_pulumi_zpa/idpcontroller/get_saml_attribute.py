...
def get_saml_attribute(id: Optional[str] = None,
    ...
    email_user_sso = zpa.idpController.get_saml_attribute(name="Email_User SSO")
    ```
    ...
    department = zpa.idpController.get_saml_attribute(name="DepartmentName_IdP_Name_Users")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:idpController/getSAMLAttribute:getSAMLAttribute', __args__, opts=opts, typ=GetSAMLAttributeResult).value
