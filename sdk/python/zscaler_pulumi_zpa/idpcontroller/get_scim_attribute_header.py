...
def get_scim_attribute_header(idp_id: Optional[str] = None,
    ...
    given_name = zpa.idpController.get_scim_attribute_header(idp_name="IdP_Name",
        name="name.givenName")
    family_name = zpa.idpController.get_scim_attribute_header(idp_name="IdP_Name",
    ...
    __ret__ = pulumi.runtime.invoke('zpa:idpController/getSCIMAttributeHeader:getSCIMAttributeHeader', __args__, opts=opts, typ=GetSCIMAttributeHeaderResult).value
