...
class ZPAApplicationSegmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentServerGroupArgs']]] server_groups: List of Server Group IDs
...
class ZPAApplicationSegment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] passive_health_enabled: (Optional)
        :param pulumi.Input[str] segment_group_id: List of Segment Group IDs
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAApplicationSegmentServerGroupArgs']]]] server_groups: List of Server Group IDs
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tcp_port_ranges: TCP port ranges used to access the app.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] udp_port_ranges: UDP port ranges used to access the app.
        """
        ...
