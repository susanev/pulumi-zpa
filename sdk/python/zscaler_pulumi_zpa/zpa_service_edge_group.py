...
class ZPAServiceEdgeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] is_public: Enable or disable public access for the Service Edge Group. Default value: `FALSE` Supported values: `DEFAULT`, `TRUE`, `FALSE`
        :param pulumi.Input[str] name: Name of the Service Edge Group.
        :param pulumi.Input[bool] override_version_profile: Whether the default version profile of the App Connector Group is applied or overridden. Default: `true`. Supported values: `true`, `false`
        :param pulumi.Input[Sequence[pulumi.Input['ZPAServiceEdgeGroupTrustedNetworkArgs']]] trusted_networks: Trusted networks for this Service Edge Group. List of trusted network objects
        ...
        :param pulumi.Input[str] version_profile_id: ID of the version profile. To learn more, see Version Profile Use Cases. This value becomes required if the value for `override_version_profile` is set to `true`.
...
class ZPAServiceEdgeGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Name of the Service Edge Group.
        :param pulumi.Input[bool] override_version_profile: Whether the default version profile of the App Connector Group is applied or overridden. Default: `true`. Supported values: `true`, `false`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAServiceEdgeGroupTrustedNetworkArgs']]]] trusted_networks: Trusted networks for this Service Edge Group. List of trusted network objects
        :param pulumi.Input[str] upgrade_day: Service Edges in this group will attempt to update to a newer version of the software during this specified day. Default value: `SUNDAY` List of valid days (i.e., Sunday, Monday)
        :param pulumi.Input[str] upgrade_time_in_secs: Service Edges in this group will attempt to update to a newer version of the software during this specified time. Default value: `66600` Integer in seconds (i..e, 66600). The integer must be greater than or equal to 0 and less than `86400`, in `15` minute intervals
        :param pulumi.Input[str] version_profile_id: ID of the version profile. To learn more, see Version Profile Use Cases. This value becomes required if the value for `override_version_profile` is set to `true`.
        :param pulumi.Input[str] version_profile_name: ID of the version profile.
