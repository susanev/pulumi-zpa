...
def get_inspection_profile(id: Optional[str] = None,
    ...
    this = zpa.Inspection.get_inspection_profile(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Inspection/getInspectionProfile:getInspectionProfile', __args__, opts=opts, typ=GetInspectionProfileResult).value
    ...
    return AwaitableGetInspectionProfileResult(
        ...
        web_socket_controls=__ret__.web_socket_controls)
