...
__all__ = ['ZPAApplicationSegmentPRAArgs', 'ZPAApplicationSegmentPRA']

@pulumi.input_type
class ZPAApplicationSegmentPRAArgs:
    def __init__(__self__, *,
                 segment_group_id: pulumi.Input[str],
                 server_groups: pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]],
                 bypass_type: Optional[pulumi.Input[str]] = None,
                 common_apps_dto: Optional[pulumi.Input['ZPAApplicationSegmentPRACommonAppsDtoArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]] server_groups: List of Server Group IDs
        :param pulumi.Input[str] bypass_type: (Optional) Indicates whether users can bypass ZPA to access applications.
        :param pulumi.Input['ZPAApplicationSegmentPRACommonAppsDtoArgs'] common_apps_dto: List of applications (e.g., Inspection, Browser Access or Privileged Remote Access)
    ...
    def server_groups(self) -> pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]]:
        """
    ...
    def server_groups(self, value: pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]]):
    ...
    def common_apps_dto(self) -> Optional[pulumi.Input['ZPAApplicationSegmentPRACommonAppsDtoArgs']]:
        """
    ...
    def common_apps_dto(self, value: Optional[pulumi.Input['ZPAApplicationSegmentPRACommonAppsDtoArgs']]):
...
@pulumi.input_type
class _ZPAApplicationSegmentPRAState:
    def __init__(__self__, *,
                 bypass_type: Optional[pulumi.Input[str]] = None,
                 common_apps_dto: Optional[pulumi.Input['ZPAApplicationSegmentPRACommonAppsDtoArgs']] = None,
                 config_space: Optional[pulumi.Input[str]] = None,
                 ...
                 segment_group_name: Optional[pulumi.Input[str]] = None,
                 server_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]]] = None,
                 tcp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="serverGroups")
    def server_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]]]:
        """
        List of Server Group IDs
        """
        return pulumi.get(self, "server_groups")
    ...
    @server_groups.setter
    def server_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAApplicationSegmentPRAServerGroupArgs']]]]):
        pulumi.set(self, "server_groups", value)
...
class ZPAApplicationSegmentPRA(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 bypass_type: Optional[pulumi.Input[str]] = None,
                 common_apps_dto: Optional[pulumi.Input[pulumi.InputType['ZPAApplicationSegmentPRACommonAppsDtoArgs']]] = None,
                 config_space: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 domain_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 double_encrypt: Optional[pulumi.Input[bool]] = None,
                 ...
                 segment_group_id: Optional[pulumi.Input[str]] = None,
                 segment_group_name: Optional[pulumi.Input[str]] = None,
                 server_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAApplicationSegmentPRAServerGroupArgs']]]]] = None,
                 tcp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] bypass_type: (Optional) Indicates whether users can bypass ZPA to access applications.
        :param pulumi.Input[pulumi.InputType['ZPAApplicationSegmentPRACommonAppsDtoArgs']] common_apps_dto: List of applications (e.g., Inspection, Browser Access or Privileged Remote Access)
               * `apps_config:` - (Required) List of applications to be configured
        :param pulumi.Input[str] config_space: (Optional)
        :param pulumi.Input[str] description: (Optional) Description of the application.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] domain_names: List of domains and IPs.
        ...
        :param pulumi.Input[bool] passive_health_enabled: (Optional)
        :param pulumi.Input[str] segment_group_id: List of Segment Group IDs
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAApplicationSegmentPRAServerGroupArgs']]]] server_groups: List of Server Group IDs
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tcp_port_ranges: TCP port ranges used to access the app.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] udp_port_ranges: UDP port ranges used to access the app.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ZPAApplicationSegmentPRAArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The **zpa_application_segment_pra** resource creates an application segment for Privileged Remote Access in the Zscaler Private Access cloud. This resource can then be referenced in an access policy rule, access policy timeout rule, access policy client forwarding rule and inspection policy. This resource supports Privileged Remote Access for both `RDP` and `SSH`.
        ...
        :param str resource_name: The name of the resource.
        :param ZPAApplicationSegmentPRAArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZPAApplicationSegmentPRAArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZPAApplicationSegmentPRAArgs.__new__(ZPAApplicationSegmentPRAArgs)
        ...
        super(ZPAApplicationSegmentPRA, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            server_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAApplicationSegmentPRAServerGroupArgs']]]]] = None,
            tcp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'ZPAApplicationSegmentPRA':
        """
        Get an existing ZPAApplicationSegmentPRA resource's state with the given name, id, and optional extra
        ...
        __props__ = _ZPAApplicationSegmentPRAState.__new__(_ZPAApplicationSegmentPRAState)
        ...
        __props__.__dict__["tcp_port_ranges"] = tcp_port_ranges
        __props__.__dict__["udp_port_ranges"] = udp_port_ranges
        return ZPAApplicationSegmentPRA(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="commonAppsDto")
    def common_apps_dto(self) -> pulumi.Output['outputs.ZPAApplicationSegmentPRACommonAppsDto']:
        """
        List of applications (e.g., Inspection, Browser Access or Privileged Remote Access)
        * `apps_config:` - (Required) List of applications to be configured
        """
    ...
    @property
    @pulumi.getter(name="serverGroups")
    def server_groups(self) -> pulumi.Output[Sequence['outputs.ZPAApplicationSegmentPRAServerGroup']]:
        """
        List of Server Group IDs
        """
        return pulumi.get(self, "server_groups")
