...
def get_application_server(id: Optional[str] = None,
    ...
    example = zpa.Server.get_application_server(name="server.example.com")
    ```
    ...
    example = zpa.Server.get_application_server(id="1234567890")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zpa:Server/getApplicationServer:getApplicationServer', __args__, opts=opts, typ=GetApplicationServerResult).value
